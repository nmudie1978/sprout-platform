...
async function seedTestMessages() {
  ...
  const testMessages = [
    {
      ...
      renderedMessage: 'Hi! Are you available on Saturday 25th January in the morning (9am-12pm)?',
    ...
    },
    {
      ...
      renderedMessage: 'Yes, I can make it! I finish school at 3pm on weekdays but Saturday mornings work great.',
    ...
    },
    {
      ...
      renderedMessage: 'Great! The job is at 42 Oak Street. Ring the doorbell at the side gate.',
    ...
    },
    {
      ...
      renderedMessage: 'Should I bring any equipment or will everything be provided?',
    ...
    },
    {
      ...
      renderedMessage: 'Everything will be provided - gloves, bags, and tools. Just wear clothes you don\'t mind getting dirty!',
    ...
    },
    {
      ...
      renderedMessage: 'Will I be paid in cash or bank transfer?',
    ...
    },
    {
      ...
      renderedMessage: 'I\'ll pay you £40 in cash at the end of the job.',
    ...
    },
    {
      ...
      renderedMessage: 'Perfect, that works for me. See you Saturday!',
    ...
    },
    {
      ...
      renderedMessage: 'Just a reminder - my wife will also be home if you need anything. Looking forward to it!',
    ...
    },
    {
      ...
      renderedMessage: 'Confirmed! I\'ll be there for 3 hours from 9am to 12pm.',
  ...
  for (let i = 0; i < testMessages.length; i++) {
    ...
    console.log(`  ${i + 1}. [${senderName}] ${msg.renderedMessage.substring(0, 50)}...`);
  }
