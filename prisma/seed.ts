import { PrismaClient, LifeSkillAudience, SkillCategory, TrustSignalType, TrustSignalSource } from '@prisma/client';
...
async function main() {
  ...
  await seedExecutiveCareers(prisma);
  console.log('✅ Created executive career cards');
