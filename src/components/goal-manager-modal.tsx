 ...
 * - NO concept of secondary, third, or unlimited goals
 *
 * Use the goal setting flow in CareerDetailSheet instead (via Explore Careers page).
 * Users set their goal by clicking "Set as Primary Goal" on a career, which
 * replaces any existing primary goal.
 *
