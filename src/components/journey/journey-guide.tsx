...
const LENSES = [
  {
    ...
    description: 'Reflect on your strengths, explore careers that interest you, and research what roles actually involve.',
    icon: Search,
    color: '#7c3aed',
  ...
  },
  {
    ...
    description: 'Review industry trends, shadow someone in your field, and create a concrete action plan.',
    icon: Globe,
    color: '#059669',
  ...
  },
  {
    ...
    description: 'Complete a real action aligned with your goal, then reflect on what you learned.',
    icon: Zap,
    color: '#d97706',
