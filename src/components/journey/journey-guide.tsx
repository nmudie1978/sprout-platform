...
const LENSES = [
  {
    ...
    description: 'Get a high-level view of any career — what it is, who does it, salary range, growth outlook, and whether it\'s worth a closer look.',
    icon: Search,
    color: '#7c3aed',
    bgClass: 'bg-teal-500/10',
    textClass: 'text-teal-400',
    borderClass: 'border-teal-500/30',
    steps: ['Explore Careers', 'Watch a Day in the Life', 'Save the Ones That Spark You'],
  },
  {
    id: 'UNDERSTAND' as const,
    title: 'Understand',
    subtitle: 'Know the reality',
    description: 'Go deeper into what the role actually involves day to day — the qualifications, the hard parts, the typical week, and what it really takes to qualify.',
    icon: Globe,
    color: '#059669',
    bgClass: 'bg-emerald-500/10',
    textClass: 'text-emerald-400',
    borderClass: 'border-emerald-500/30',
    steps: ['Role Deep Dive', 'Review Industry Outlook', 'Understand the Path'],
  },
  {
    id: 'ACT' as const,
    title: 'Grow',
    subtitle: 'Build your roadmap',
    description: 'Map your path toward this career, set concrete next steps, track your progress over time, and build momentum.',
    icon: Zap,
    color: '#d97706',
    bgClass: 'bg-amber-500/10',
    textClass: 'text-amber-400',
    borderClass: 'border-amber-500/30',
    steps: ['Build Your Roadmap', 'Set Next Steps', 'Track Your Progress', 'Build Momentum'],
  },
];
