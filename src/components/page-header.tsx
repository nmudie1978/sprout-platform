          ...
          <TooltipProvider delayDuration={150}>
            <Tooltip>
              <TooltipTrigger asChild>
                <button className="hit-44 h-8 w-8 rounded-full border border-border/50 bg-card/80 flex items-center justify-center hover:bg-card transition-colors cursor-help">
