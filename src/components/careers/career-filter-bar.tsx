  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className="flex items-center gap-1.5 h-10 sm:h-8 px-3 sm:px-2.5 rounded-md border border-border bg-card text-xs text-foreground hover:bg-muted transition-colors whitespace-nowrap overflow-hidden max-w-[180px]"
      ...
      <div className="flex flex-wrap items-center justify-center gap-2">
        ...
        <div className="relative w-full sm:flex-1 sm:w-auto sm:min-w-[160px] sm:max-w-xs">
          ...
          <Input
            ...
            className="h-10 sm:h-8 pl-8 sm:pl-7 text-sm sm:text-xs bg-card border-input text-foreground placeholder:text-muted-foreground"
          />
          {localSearch && (
            <button
        ...
        <select
          ...
          className="h-10 sm:h-8 px-2.5 sm:px-2 rounded-md border border-border bg-card text-xs text-foreground [&>option]:text-foreground"
