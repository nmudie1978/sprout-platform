...
export const metadata = {
  title: "About Sprout | Helping Young People Take Their First Steps",
  description: "Sprout helps young people aged 16-20 earn money through local jobs, gain real-world experience, and explore future careers in a safe environment.",
};
