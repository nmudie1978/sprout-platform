...
const OBSERVATIONS = [
  {
    number: "01",
    text: "You\u2019re asked to choose a direction before you\u2019ve had a chance to experience anything real. School prepares you to decide \u2014 not to explore.",
  },
  {
    number: "02",
    text: "Most career advice assumes you already know what you\u2019re interested in. If you don\u2019t, it has nothing useful to say.",
  },
  {
    number: "03",
    text: "The pressure to \u201Cfigure it out\u201D actually makes it harder to figure it out. Clarity comes from doing, not deciding under stress.",
  },
];
...
export default function LandingPageV3() {
  return (
    <div className="min-h-screen bg-slate-950">
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-5 pt-28 pb-20 sm:pt-36 sm:pb-28">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="max-w-2xl">
              {/* Context label */}
              <p className="text-[11px] font-medium uppercase tracking-[0.2em] text-neutral-600 mb-12 sm:mb-16">
                For 15–23 year olds
              </p>

              {/* Headline — normalising, not motivating */}
              <h1 className="text-3xl sm:text-4xl md:text-[2.75rem] font-semibold tracking-tight leading-snug text-white mb-10 sm:mb-12">
                Your future is yours to explore.
              </h1>

              {/* Pull-quote — grounding context */}
              <div className="border-l-2 border-emerald-500/30 pl-6 mb-12 sm:mb-14">
      ...
      {/* ============================================ */}
      {/* SECTION 2 — THE PRESSURE */}
      {/* ============================================ */}
      <section className="border-t border-slate-800/60">
        <div className="mx-auto max-w-6xl px-5 py-24 sm:py-32">
          <div className="max-w-2xl">
            {/* Section label */}
            <p className="text-[11px] font-medium uppercase tracking-[0.2em] text-neutral-600 mb-14 sm:mb-16">
            ...
            <div className="space-y-14 sm:space-y-16">
              {OBSERVATIONS.map((obs) => (
                <div key={obs.number}>
                  <span className="text-xs font-medium text-neutral-700 mb-3 block">
                    {obs.number}
                  </span>
                  <p className="text-xl sm:text-2xl text-neutral-300 leading-relaxed font-light max-w-xl">
                    {obs.text}
                  </p>
                </div>
              ))}
          ...
          <div className="max-w-2xl">
            ...
            <div className="space-y-6 max-w-xl">
              <p className="text-base sm:text-[17px] text-neutral-400 leading-relaxed">
                A space for young people to explore careers honestly, try small
                real-world experiences, and reflect on what fits — without
                anyone telling them what to think or who to become.
              </p>
              <p className="text-base sm:text-[17px] text-neutral-400 leading-relaxed">
      ...
      {/* ============================================ */}
      {/* SECTION 3a — A GENTLE STRUCTURE (4 PILLARS) */}
      {/* ============================================ */}
      <section className="border-t border-slate-800/60">
        <div className="mx-auto max-w-6xl px-5 py-24 sm:py-32">
          {/* Section header */}
