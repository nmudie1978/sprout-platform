...
const testimonials: Testimonial[] = [
  // ── Europe ──────────────────────────────────────────────
  { text: "Endeavrly helped me figure out what I actually want to do after school. The journey framework made it click — I went from completely lost to having a real plan.", image: "https://images.unsplash.com/photo-1611432579699-484f7990b127?w=80&h=80&fit=crop&crop=face", name: "Marcus, 17", role: "Student, London, UK" },
  ...
  { text: "The industry insights section opened my eyes. I had no idea renewable energy was growing so fast in Norway. Now that's my goal.", image: "https://images.unsplash.com/photo-1596075780750-81249df16d19?w=80&h=80&fit=crop&crop=face", name: "Lars, 20", role: "Engineering Student, Trondheim, Norway" },
  { text: "As someone who's neurodivergent, the calm design and structured approach made this the first career tool I actually finished. No overwhelming dashboards.", image: "https://images.unsplash.com/photo-1599566150163-29194dcabd9c?w=80&h=80&fit=crop&crop=face", name: "Ethan, 19", role: "Uni Fresher, Edinburgh, UK" },
  ...
  { text: "The reflection prompts after each step made me think properly about my choices. It's not just a tick-box exercise — you actually grow through the process.", image: "https://images.unsplash.com/photo-1603415526960-f7e0328c63b1?w=80&h=80&fit=crop&crop=face", name: "Kai, 21", role: "Apprentice Electrician, Cardiff, UK" },
  ...
  { text: "I've completed three small jobs so far and built real skills. Employers can see my responsibility signals which is brilliant.", image: "https://images.unsplash.com/photo-1596075780750-81249df16d19?w=80&h=80&fit=crop&crop=face", name: "Liam, 20", role: "Freelance Designer, Toronto, Canada" },
  ...
  { text: "I'm from a small town in Alberta. There aren't many career resources here. Endeavrly filled that gap completely — it's accessible from anywhere.", image: "https://images.unsplash.com/photo-1605462863863-10d9e47e15ee?w=80&h=80&fit=crop&crop=face", name: "Noah, 19", role: "Student, Edmonton, Canada" },
  ...
  { text: "The industry insights for tech in Latin America were eye-opening. I didn't know so many companies were hiring juniors remotely.", image: "https://images.unsplash.com/photo-1601288496920-b6154fe3626a?w=80&h=80&fit=crop&crop=face", name: "Valentina, 19", role: "CS Student, Bogotá, Colombia" },
  ...
  { text: "Coming from a rural area in Bolivia, I had zero career guidance. Endeavrly gave me the same tools kids in big cities have.", image: "https://images.unsplash.com/photo-1621592484082-2d05b1290d7a?w=80&h=80&fit=crop&crop=face", name: "Miguel, 17", role: "Student, Cochabamba, Bolivia" },
  ...
  { text: "The career insights for the tech industry in Asia were incredibly detailed. I could see growth trends, salary ranges, and required skills.", image: "https://images.unsplash.com/photo-1600486913747-55e5470d6f40?w=80&h=80&fit=crop&crop=face", name: "Wei, 21", role: "CS Graduate, Shanghai, China" },
  ...
  { text: "The action plan I built in the Understand stage is something I actually use every week. It's practical, not theoretical.", image: "https://images.unsplash.com/photo-1615813967515-e1838c1c5116?w=80&h=80&fit=crop&crop=face", name: "Rami, 19", role: "Student, Beirut, Lebanon" },
  ...
  { text: "The career roadmap for architecture was incredibly detailed. It even showed me what subjects to pick at A-level. That's the kind of detail that matters.", image: "https://images.unsplash.com/photo-1611432579699-484f7990b127?w=80&h=80&fit=crop&crop=face", name: "Oscar, 17", role: "Student, Stockholm, Sweden" },
  ...
  { text: "The fact that the platform is privacy-first is huge. No tracking, no selling my data. My parents were relieved when I showed them the safety page.", image: "https://images.unsplash.com/photo-1601288496920-b6154fe3626a?w=80&h=80&fit=crop&crop=face", name: "Lily, 15", role: "Year 10, Oxford, UK" },
  ...
  { text: "The best thing about Endeavrly is that it takes you seriously. It doesn't dumb things down or treat you like you can't handle real information.", image: "https://images.unsplash.com/photo-1596075780750-81249df16d19?w=80&h=80&fit=crop&crop=face", name: "Sam, 17", role: "Student, Nashville, TN, USA" },
