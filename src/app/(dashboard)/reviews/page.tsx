...
const reviews: Review[] = [
  ...
  { text: "Discover, Understand, Grow — three tabs, each one gives you a different lens on the same career.", name: "Mia, 17", role: "Student, Brisbane, Australia", image: "https://images.unsplash.com/photo-1502767089025-6572583495f9?w=80&h=80&fit=crop&crop=face" },
