...
const testimonials: Testimonial[] = [
  // ── Europe ──────────────────────────────────────────────
  { text: "Endeavrly helped me figure out what I actually want to do after school. The journey framework made it click — I went from completely lost to having a real plan.", image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=80&h=80&fit=crop&crop=face", name: "Marcus, 17", role: "Student, London, UK" },
  ...
  { text: "Endeavrly hjalp meg å forstå styrkene mine. Nå vet jeg hvilken retning jeg vil ta etter videregående. Fantastisk verktøy!", image: "https://images.unsplash.com/photo-1463453091185-61582044d556?w=80&h=80&fit=crop&crop=face", name: "Henrik, 17", role: "Student, Oslo, Norway" },
  ...
  { text: "The industry insights section opened my eyes. I had no idea renewable energy was growing so fast in Norway. Now that's my goal.", image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=80&h=80&fit=crop&crop=face", name: "Lars, 20", role: "Engineering Student, Trondheim, Norway" },
  { text: "As someone who's neurodivergent, the calm design and structured approach made this the first career tool I actually finished. No overwhelming dashboards.", image: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=80&h=80&fit=crop&crop=face", name: "Ethan, 19", role: "Uni Fresher, Edinburgh, UK" },
  ...
  { text: "Endeavrly doesn't just throw jobs at you. It helps you understand yourself first, then the world, then act. That order matters.", image: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=80&h=80&fit=crop&crop=face", name: "Zara, 22", role: "Graduate, Leeds, UK" },
  ...
  { text: "The reflection prompts after each step made me think properly about my choices. It's not just a tick-box exercise — you actually grow through the process.", image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=80&h=80&fit=crop&crop=face", name: "Kai, 21", role: "Apprentice Electrician, Cardiff, UK" },
  { text: "Alles ist so klar strukturiert. Ich habe zum ersten Mal das Gefühl, dass mir jemand wirklich hilft, meinen Weg zu finden.", image: "https://images.unsplash.com/photo-1560250097-0b93528c311a?w=80&h=80&fit=crop&crop=face", name: "Felix, 17", role: "Schüler, Berlin, Germany" },
  ...
  { text: "I completed five small jobs and each one taught me something new. The responsibility signals gave me confidence I didn't have before.", image: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=80&h=80&fit=crop&crop=face", name: "Matteo, 20", role: "Part-time Tutor, Milan, Italy" },
  ...
  { text: "I never had career guidance at school. Endeavrly gave me everything — self-reflection, industry research, and a plan. All in one place.", image: "https://images.unsplash.com/photo-1557862921-37829c790f19?w=80&h=80&fit=crop&crop=face", name: "Dmitri, 19", role: "Student, Moscow, Russia" },
  ...
  { text: "Finally a platform that takes young people seriously. No patronising language, no childish design — just genuine career support.", image: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=80&h=80&fit=crop&crop=face", name: "Petra, 21", role: "Graduate, Prague, Czech Republic" },
  ...
  { text: "I've completed three small jobs so far and built real skills. Employers can see my responsibility signals which is brilliant.", image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=80&h=80&fit=crop&crop=face", name: "Liam, 20", role: "Freelance Designer, Toronto, Canada" },
  ...
  { text: "I'm from a small town in Alberta. There aren't many career resources here. Endeavrly filled that gap completely — it's accessible from anywhere.", image: "https://images.unsplash.com/photo-1552058544-f2b08422138a?w=80&h=80&fit=crop&crop=face", name: "Noah, 19", role: "Student, Edmonton, Canada" },
  { text: "The Grow stage pushed me to actually do things, not just read about them. I volunteered, shadowed someone, and started a small project — all from the prompts.", image: "https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?w=80&h=80&fit=crop&crop=face", name: "Olivia, 21", role: "Recent Grad, Vancouver, Canada" },
  { text: "Endeavrly respects my privacy. No ads, no tracking, no dark patterns. That matters to me as a young person online.", image: "https://images.unsplash.com/photo-1545167622-3a6ac756afa4?w=80&h=80&fit=crop&crop=face", name: "Ethan, 16", role: "Sophomore, Portland, OR, USA" },
  ...
  { text: "The industry insights for tech in Latin America were eye-opening. I didn't know so many companies were hiring juniors remotely.", image: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=80&h=80&fit=crop&crop=face", name: "Valentina, 19", role: "CS Student, Bogotá, Colombia" },
  { text: "I love how the platform doesn't assume everyone's path looks the same. It works for trades, creative fields, and academic routes equally.", image: "https://images.unsplash.com/photo-1542909168-82c3e7fdca5c?w=80&h=80&fit=crop&crop=face", name: "Carlos, 18", role: "Student, Mexico City, Mexico" },
  ...
  { text: "Coming from a rural area in Bolivia, I had zero career guidance. Endeavrly gave me the same tools kids in big cities have.", image: "https://images.unsplash.com/photo-1504257432389-52343af06ae3?w=80&h=80&fit=crop&crop=face", name: "Miguel, 17", role: "Student, Cochabamba, Bolivia" },
  ...
  { text: "No other platform explains what a career actually looks like day to day. The typical day feature is my favourite part.", image: "https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?w=80&h=80&fit=crop&crop=face", name: "Diego, 19", role: "Intern, Lima, Peru" },
  ...
  { text: "Endeavrly is mint. I was totally lost about what to do after year 12 and now I've got a solid plan for getting into marine biology.", image: "https://images.unsplash.com/photo-1492562080023-ab3db95bfbce?w=80&h=80&fit=crop&crop=face", name: "Jack, 18", role: "Year 12, Sydney, Australia" },
  ...
  { text: "I've explored six different careers and learned something from each one. The platform never judges you for changing your mind.", image: "https://images.unsplash.com/photo-1564564321837-a57b7070ac4f?w=80&h=80&fit=crop&crop=face", name: "Cooper, 19", role: "TAFE Student, Melbourne, Australia" },
  ...
  { text: "My school introduced us to Endeavrly and within a week, half our class had set career goals for the first time.", image: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=80&h=80&fit=crop&crop=face", name: "Tendai, 17", role: "Student, Harare, Zimbabwe" },
  ...
  { text: "The career insights for the tech industry in Asia were incredibly detailed. I could see growth trends, salary ranges, and required skills.", image: "https://images.unsplash.com/photo-1560250097-0b93528c311a?w=80&h=80&fit=crop&crop=face", name: "Wei, 21", role: "CS Graduate, Shanghai, China" },
  { text: "I'm from a small town in the Philippines. Career guidance doesn't exist here. Endeavrly gave me direction I never had before.", image: "https://images.unsplash.com/photo-1504257432389-52343af06ae3?w=80&h=80&fit=crop&crop=face", name: "Marco, 18", role: "Student, Cebu, Philippines" },

  // ── Middle East ─────────────────────────────────────────
  { text: "The Grow stage motivated me to take real action. I started a coding project, volunteered at a tech startup, and now I have real experience.", image: "https://images.unsplash.com/photo-1557862921-37829c790f19?w=80&h=80&fit=crop&crop=face", name: "Omar, 20", role: "Student, Dubai, UAE" },
  { text: "I love that Endeavrly doesn't rank you against other people. It's about your own growth, your own journey. That's refreshing.", image: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=80&h=80&fit=crop&crop=face", name: "Layla, 17", role: "Student, Amman, Jordan" },
  { text: "The action plan I built in the Understand stage is something I actually use every week. It's practical, not theoretical.", image: "https://images.unsplash.com/photo-1542909168-82c3e7fdca5c?w=80&h=80&fit=crop&crop=face", name: "Rami, 19", role: "Student, Beirut, Lebanon" },
  ...
  { text: "The career roadmap for architecture was incredibly detailed. It even showed me what subjects to pick at A-level. That's the kind of detail that matters.", image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=80&h=80&fit=crop&crop=face", name: "Oscar, 17", role: "Student, Stockholm, Sweden" },
  ...
  { text: "The small jobs on Endeavrly are perfect for teens. Safe, structured, and they actually build skills employers care about.", image: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=80&h=80&fit=crop&crop=face", name: "Finn, 16", role: "Student, Helsinki, Finland" },
  ...
  { text: "I've tried other career platforms. They all feel like job boards for adults. Endeavrly actually understands what teenagers need.", image: "https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?w=80&h=80&fit=crop&crop=face", name: "Sarah, 17", role: "Student, Zurich, Switzerland" },
  ...
  { text: "My older brother used Endeavrly and got his apprenticeship. Now I'm using it too. The whole framework just works.", image: "https://images.unsplash.com/photo-1492562080023-ab3db95bfbce?w=80&h=80&fit=crop&crop=face", name: "Luca, 15", role: "Year 10, Rome, Italy" },
  ...
  { text: "The career exploration feature introduced me to jobs I didn't even know existed. Supply chain analytics? That's now my top choice.", image: "https://images.unsplash.com/photo-1564564321837-a57b7070ac4f?w=80&h=80&fit=crop&crop=face", name: "Alex, 19", role: "Student, Montréal, Canada" },
  ...
  { text: "Setting a career goal and then seeing the full roadmap — qualifications, skills, typical day — was a game changer. I finally had clarity.", image: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=80&h=80&fit=crop&crop=face", name: "Jade, 22", role: "Junior Dev, Bristol, UK" },
  ...
  { text: "The platform helped me realise that my gap year wasn't wasted — I used Endeavrly to research, reflect, and plan. Best decision I made.", image: "https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?w=80&h=80&fit=crop&crop=face", name: "Tom, 19", role: "Gap Year, Cape Town, South Africa" },
  ...
  { text: "After completing the full journey, I had a one-page career plan, five completed reflections, and real work experience. All from one platform.", image: "https://images.unsplash.com/photo-1545167622-3a6ac756afa4?w=80&h=80&fit=crop&crop=face", name: "Ryan, 21", role: "Graduate, Dublin, Ireland" },
  ...
  { text: "Endeavrly taught me what 'transferable skills' actually means. I now know that my babysitting experience is worth something to employers.", image: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=80&h=80&fit=crop&crop=face", name: "Caitlin, 18", role: "Part-time Carer, Glasgow, UK" },
  { text: "I used the industry insights to prepare for a school presentation about AI careers. Got top marks. Thanks Endeavrly!", image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=80&h=80&fit=crop&crop=face", name: "Leo, 16", role: "Student, Barcelona, Spain" },
  ...
  { text: "I'm a refugee and career guidance was never available to me. Endeavrly doesn't care where you're from — it just helps you move forward.", image: "https://images.unsplash.com/photo-1552058544-f2b08422138a?w=80&h=80&fit=crop&crop=face", name: "Ahmad, 19", role: "Student, Malmö, Sweden" },
  ...
  { text: "The fact that the platform is privacy-first is huge. No tracking, no selling my data. My parents were relieved when I showed them the safety page.", image: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=80&h=80&fit=crop&crop=face", name: "Lily, 15", role: "Year 10, Oxford, UK" },
  ...
  { text: "I used to think I had to choose between university and a trade. Endeavrly showed me both paths clearly and I chose what was right for me.", image: "https://images.unsplash.com/photo-1560250097-0b93528c311a?w=80&h=80&fit=crop&crop=face", name: "Connor, 18", role: "Apprentice, Auckland, New Zealand" },
  { text: "The way Endeavrly explains each career — the reality, the skills, the path — it's like having a personal advisor who actually knows what they're talking about.", image: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=80&h=80&fit=crop&crop=face", name: "James, 21", role: "Junior Analyst, London, UK" },
  ...
  { text: "The best thing about Endeavrly is that it takes you seriously. It doesn't dumb things down or treat you like you can't handle real information.", image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=80&h=80&fit=crop&crop=face", name: "Sam, 17", role: "Student, Nashville, TN, USA" },
  { text: "I explored veterinary science and realised it wasn't for me. But instead of feeling like I failed, Endeavrly helped me redirect to zoology. Smooth.", image: "https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?w=80&h=80&fit=crop&crop=face", name: "Phoebe, 16", role: "Year 11, Dunedin, New Zealand" },
  { text: "Coming from a refugee background, I had no career role models. Endeavrly showed me paths I never knew existed and made them feel achievable.", image: "https://images.unsplash.com/photo-1542909168-82c3e7fdca5c?w=80&h=80&fit=crop&crop=face", name: "Hassan, 18", role: "Student, Oslo, Norway" },
  ...
  { text: "My school doesn't offer career guidance until year 12. With Endeavrly, I started in year 9 and I'm already ahead of everyone.", image: "https://images.unsplash.com/photo-1504257432389-52343af06ae3?w=80&h=80&fit=crop&crop=face", name: "Lachlan, 15", role: "Year 9, Gold Coast, Australia" },
      ...
      <div className="container z-10 mx-auto px-4 py-8 max-w-5xl">
        ...
        >
          <div className="flex justify-center">
            <div className="inline-flex items-center gap-2 border py-1 px-4 rounded-lg text-sm text-muted-foreground">
          ...
          <p className="text-center mt-3 text-sm text-muted-foreground/70">
            Real feedback from 15–23 year olds across the world using Endeavrly to discover their path, build skills, and take meaningful action.
          </p>
        </motion.div>
