...
export const DATASET_VERSION = "2026-Q1-v1";
export const DATASET_RETRIEVED_AT = "2026-03-25T00:00:00Z";
...
const iloOecd: StatProvenance = {
  ...
  sourceUrl: "https://www.ilo.org/publications/flagship-reports/employment-and-social-trends-2026",
  reportTitle: "Employment and Social Trends 2026",
  publishedDate: "2026-01",
  retrievedAt: DATASET_RETRIEVED_AT,
  citation: "ILO, Employment and Social Trends 2026, January 2026.",
};
...
const oecdLabour: StatProvenance = {
  sourceName: "OECD",
  sourceUrl: "https://www.oecd.org/en/publications/oecd-employment-outlook-2025_194a947b-en.html",
  reportTitle: "OECD Employment Outlook 2025",
  publishedDate: "2025-07",
  retrievedAt: DATASET_RETRIEVED_AT,
  citation: "OECD, Employment Outlook 2025, July 2025.",
};
...
const navSsb: StatProvenance = {
  ...
  publishedDate: "2026-Q1",
  retrievedAt: DATASET_RETRIEVED_AT,
  citation: "NAV & SSB, Labour Market Statistics, Q1 2026.",
};
...
const navSurveys: StatProvenance = {
  ...
  reportTitle: "NAV Employer Survey 2025",
  publishedDate: "2025-Q3",
  retrievedAt: DATASET_RETRIEVED_AT,
  citation: "NAV, Employer Survey Results, Q3 2025.",
};

const eurostat: StatProvenance = {
  sourceName: "Eurostat",
  sourceUrl: "https://ec.europa.eu/eurostat/web/labour-market",
  reportTitle: "Labour Force Survey 2025",
  publishedDate: "2025-Q4",
  retrievedAt: DATASET_RETRIEVED_AT,
  citation: "Eurostat, Labour Force Survey, Q4 2025.",
};

const linkedinEconomic: StatProvenance = {
  sourceName: "LinkedIn Economic Graph",
  sourceUrl: "https://economicgraph.linkedin.com/research/work-change-report",
  reportTitle: "Work Change Report 2025 & Global Talent Trends",
  publishedDate: "2025-01",
  retrievedAt: DATASET_RETRIEVED_AT,
  citation: "LinkedIn Economic Graph, Work Change Report 2025 & Global Talent Trends, January 2025.",
};
...
const mckinsey: StatProvenance = {
  ...
  reportTitle: "Agents, Robots, and Us: Skill Partnerships in the Age of AI",
  publishedDate: "2025-11",
  retrievedAt: DATASET_RETRIEVED_AT,
  citation: "McKinsey Global Institute, Agents, Robots, and Us, November 2025.",
};

const deloitte: StatProvenance = {
  sourceName: "Deloitte",
  sourceUrl: "https://www.deloitte.com/global/en/issues/work/genz-millennial-survey.html",
  reportTitle: "2025 Gen Z and Millennial Survey",
  publishedDate: "2025-06",
  retrievedAt: DATASET_RETRIEVED_AT,
  citation: "Deloitte, 2025 Gen Z and Millennial Survey, 23,000+ respondents across 44 countries.",
};

const manpower: StatProvenance = {
  sourceName: "ManpowerGroup",
  sourceUrl: "https://go.manpowergroup.com/talent-shortage",
  reportTitle: "Talent Shortage Survey 2025",
  publishedDate: "2025-Q1",
  retrievedAt: DATASET_RETRIEVED_AT,
  citation: "ManpowerGroup, Talent Shortage Survey 2025, 40,413 employers across 42 countries.",
};
...
const githubStackoverflow: StatProvenance = {
  ...
  reportTitle: "GitHub Octoverse 2025 & Stack Overflow Developer Survey 2025",
  publishedDate: "2025-10",
  retrievedAt: DATASET_RETRIEVED_AT,
  citation: "GitHub Octoverse 2025; Stack Overflow Developer Survey 2025.",
};

const nhoKompetanse: StatProvenance = {
  sourceName: "NHO / NIFU",
  sourceUrl: "https://www.nho.no/tema/kompetanse/",
  reportTitle: "NHO Kompetansebarometer 2025",
  publishedDate: "2025-Q4",
  retrievedAt: DATASET_RETRIEVED_AT,
  citation: "NHO/NIFU, Kompetansebarometer 2025, Q4 2025.",
};
...
const unicefIlo: StatProvenance = {
  ...
  retrievedAt: DATASET_RETRIEVED_AT,
  citation: "UNICEF/ILO, Global Estimates of Child Labour, 2024. (Latest available edition.)",
};

const worldBank: StatProvenance = {
  sourceName: "World Bank",
  sourceUrl: "https://www.worldbank.org/en/topic/jobsandgrowth/overview",
  reportTitle: "Jobs and Development Overview 2025",
  publishedDate: "2025-06",
  retrievedAt: DATASET_RETRIEVED_AT,
  citation: "World Bank, Jobs and Development Overview, 2025.",
};

const euDesi: StatProvenance = {
  sourceName: "European Commission",
  sourceUrl: "https://digital-strategy.ec.europa.eu/en/policies/desi",
  reportTitle: "Digital Economy and Society Index (DESI) 2025",
  publishedDate: "2025-07",
  retrievedAt: DATASET_RETRIEVED_AT,
  citation: "European Commission, DESI 2025, July 2025.",
};
...
const card3_reshapingJobs: StatDatum = {
  ...
  renderType: "donut",
  value: "~39%",
  valueContext: "of key skills changing by 2030",
  items: [
    { label: "Changing skills", value: 39, color: "#f59e0b" },
    { label: "Stable skills", value: 61, color: "#93b0c8" },
  ] as DonutSegment[],
...
const card10_youthUnemployment: StatDatum = {
  ...
  renderType: "donut",
  value: "~12.4%",
  valueContext: "global youth unemployment rate (2025)",
  items: [
    { label: "Unemployed youth", value: 12, color: "#ef4444" },
    { label: "Employed / in education", value: 88, color: "#93b0c8" },
  ] as DonutSegment[],
...
const card11_greenJobs: StatDatum = {
  ...
  renderType: "barList",
  items: [
    { label: "Renewable Energy", value: 28, color: "bg-emerald-500" },
    { label: "Energy Efficiency", value: 20, color: "bg-green-500" },
    { label: "Sustainable Transport", value: 16, color: "bg-teal-500" },
    { label: "Circular Economy", value: 12, color: "bg-lime-500" },
    { label: "Climate Adaptation", value: 9, color: "bg-cyan-500" },
  ] as BarItem[],
...
const card36_norwayTechStartups: StatDatum = {
  ...
  renderType: "iconGrid",
  items: [
    { icon: "🚀", label: "16,800+ startups", sublabel: "Active in 2025" },
    { icon: "💰", label: "$45.1B raised", sublabel: "Total VC/PE funding" },
    { icon: "🦄", label: "5 Unicorns", sublabel: "$5.7B combined value" },
...
const card51_globalJobsGap: StatDatum = {
  ...
  renderType: "metric",
  value: "408M",
  valueContext: "people worldwide face a jobs gap (2026 projection)",
  items: [
    { text: "186 million unemployed globally" },
    { text: "257 million young people are NEET" },
    { text: "2.1 billion workers in informal employment" },
    { text: "Nearly 300 million workers earn less than $3/day" },
  ] as BulletItem[],
  gradientColors: "from-rose-400 via-red-500 to-rose-400",
  iconColor: "text-rose-600",
  provenance: iloOecd,
...
const card54_renewableEnergyJobs: StatDatum = {
  ...
  note: "16.6 million total renewable energy jobs globally (2024), up from 16.2M in 2023. Solar PV alone: 7.2M jobs.",
...
const card55_genaiReshapingWork: StatDatum = {
  ...
  subtitle: "57% of work hours now automatable",
  renderType: "stackedBar",
  value: "Automation Potential",
  valueContext: "Share of U.S. work hours",
  items: [
    { label: "Automatable by AI/robots", value: 57, color: "#8b5cf6" },
    { label: "Requires human judgement", value: 43, color: "#93b0c8" },
  ] as StackedSegment[],
  note: "Technical potential — not prediction. Redesigning workflows (not just automating tasks) could add $2.9T/year to the U.S. economy.",
...
const card57_developerAiAdoption: StatDatum = {
  ...
  subtitle: "AI coding tools are the norm",
  renderType: "donut",
  value: "80%",
  valueContext: "of new GitHub developers use Copilot in week one",
  items: [
    { label: "Using AI tools", value: 80, color: "#8b5cf6" },
    { label: "Not yet using", value: 20, color: "#93b0c8" },
  ] as DonutSegment[],
  note: "1.1M+ public repos now use an LLM SDK (+178% YoY). 36M new developers joined GitHub in 2025.",
...
const card60_humanMachineAiSplit: StatDatum = {
  ...
  valueContext: "Down from 47% human-only in 2025",
  items: [
...
const card61_genaiProjectsBoom: StatDatum = {
  ...
  renderType: "metric",
  value: "1.1M+",
  valueContext: "public repos using an LLM SDK on GitHub",
  items: [
    { text: "694K LLM SDK repos created in 2025 alone (+178% YoY)" },
    { text: "36 million new developers joined GitHub in 2025" },
    { text: "TypeScript overtook Python & JS as #1 language" },
    { text: "Nearly 1 billion commits pushed in 2025 (+25% YoY)" },
  ] as BulletItem[],
  gradientColors: "from-cyan-400 via-blue-500 to-indigo-400",
  iconColor: "text-cyan-600",
  provenance: githubStackoverflow,
...
const card63_norwayTechSectorGrowth: StatDatum = {
  ...
  items: [
    ...
    { label: "Data analyst growth", value: 45, color: "bg-blue-500" },
    { label: "AI/ML opportunity spike", value: 42, color: "bg-violet-500" },
    { label: "Cybersecurity growth", value: 22, color: "bg-indigo-500" },
  ] as BarItem[],
  note: "67% of Norwegian businesses lack AI competence (NHO 2025). Power deficit expected in 2026-27 driving green/tech investment.",
...
const card64_genzPurposeDriven: StatDatum = {
  ...
  renderType: "donut",
  value: "70%",
  valueContext: "of Gen Z consider a company's environmental credentials important",
  items: [
    { label: "Purpose matters", value: 70, color: "#8b5cf6" },
    { label: "Not a priority", value: 30, color: "#93b0c8" },
  ] as DonutSegment[],
  note: "Only 6% say their primary goal is a leadership position — growth and balance matter more. Survey: 23,000+ respondents in 44 countries.",
...
const card65_genzFinancialPressure: StatDatum = {
  ...
  renderType: "metric",
  value: "48%",
  valueContext: "of Gen Z do not feel financially secure (2025)",
  items: [
    { text: "Up from 30% in 2024 — a sharp increase" },
    { text: "Only 28% of financially insecure Gen Z feel happy" },
    { text: "46% of millennials also feel financially insecure" },
    { text: "Money, meaning, and well-being form the 'trifecta' of career decisions" },
  ] as BulletItem[],
...
const card66_genzWorkplaceStress: StatDatum = {
  ...
  subtitle: "Burnout remains high despite awareness",
  renderType: "stackedBar",
  value: "Burnout Levels (Gen Z)",
  valueContext: "36% exhausted all or most of the time",
  items: [
    { label: "Exhausted most/all time", value: 36, color: "#ef4444" },
    { label: "Sometimes burned out", value: 42, color: "#f59e0b" },
    { label: "Rarely burned out", value: 22, color: "#22c55e" },
  ] as StackedSegment[],
  note: "42% of Gen Z struggle to perform their best due to burnout.",
...
const card67_genzClimateValues: StatDatum = {
  ...
  renderType: "barList",
  items: [
    { label: "Consider employer green credentials", value: 70, color: "bg-emerald-500" },
...
const card71_norwayYouthSnapshot: StatDatum = {
  ...
  valueContext: "Youth unemployment: 13.4% (2025 avg)",
  items: [
    { label: "Employed", value: 55, color: "#22c55e" },
    { label: "In education only", value: 30, color: "#8b5cf6" },
    { label: "NEET", value: 7, color: "#ef4444" },
    { label: "Other", value: 8, color: "#93b0c8" },
  ] as StackedSegment[],
  note: "Youth unemployment rose to 13.4% in 2025 (up from 11.6%). NEET rate still among OECD's lowest.",
...
const card73_skillsGapBarrier: StatDatum = {
  ...
  note: "39% of key skills expected to change by 2030 (down from 44% in 2023). 87% of companies report or expect a skills gap.",
...
const card88_norwayEvWorldLeader: StatDatum = {
  ...
  renderType: "iconGrid",
  items: [
    { icon: "⚡", label: "95.9% EV Sales", sublabel: "New cars in 2025" },
    { icon: "🔌", label: "30K+ Chargers", sublabel: "Public charge points" },
    { icon: "🚗", label: "179K Sold", sublabel: "+40% YoY in 2025" },
    { icon: "🏭", label: "Battery Plants", sublabel: "Morrow, Beyonder" },
    { icon: "🌍", label: "Global Leader", sublabel: "EVs outnumber diesels" },
  ] as IconGridItem[],
  gradientColors: "from-emerald-400 via-teal-500 to-cyan-400",
  iconColor: "text-emerald-600",
  provenance: navSsb,
...
const card90_norwayCcsLongship: StatDatum = {
  ...
  items: [
    ...
    { icon: "💰", label: "NOK 7.5B", sublabel: "Phase 2 expansion" },
    { icon: "🌊", label: "35,914 tonnes", sublabel: "CO2 stored by Dec 2025" },
    { icon: "📅", label: "Phase 2: 5Mt/yr", sublabel: "Expansion underway" },
  ] as IconGridItem[],
  gradientColors: "from-blue-400 via-indigo-500 to-purple-400",
  iconColor: "text-blue-600",
  provenance: navSsb,
...
const card91_globalTalentShortage: StatDatum = {
  ...
  renderType: "donut",
  value: "74%",
  valueContext: "of employers globally struggle to fill roles (2025)",
  items: [
    { label: "Difficulty filling roles", value: 74, color: "#ef4444" },
    { label: "No difficulty", value: 26, color: "#22c55e" },
  ] as DonutSegment[],
  note: "Survey of 40,413 employers across 42 countries. Doubled since 2014 (36%). Healthcare, IT, and logistics hardest hit.",
...
const card92_talentShortageByCountry: StatDatum = {
  ...
  renderType: "barList",
  items: [
    { label: "Germany", value: 86, color: "bg-red-500" },
    { label: "Israel", value: 85, color: "bg-red-400" },
    { label: "Portugal", value: 84, color: "bg-orange-500" },
    { label: "Japan", value: 83, color: "bg-orange-400" },
    { label: "UK", value: 80, color: "bg-amber-500" },
    { label: "Norway", value: 70, color: "bg-amber-400" },
  ] as BarItem[],
  note: "% of employers reporting difficulty filling positions. Puerto Rico lowest at 53%.",
  gradientColors: "from-red-400 via-orange-500 to-amber-400",
  iconColor: "text-red-500",
  provenance: manpower,
};
...
const card93_euYouthUnemploymentMap: StatDatum = {
  ...
  renderType: "barList",
  items: [
    { label: "Germany", value: 66, color: "bg-emerald-500" },
    ...
    { label: "Spain", value: 253, color: "bg-red-500" },
  ] as BarItem[],
  note: "Values ×10. Germany 6.6%, Netherlands 8.5%, Denmark 10.2%, France 15.8%, Spain 25.3%. EU avg: 15.1% (Jan 2026).",
...
const card94_oecdEmploymentRecord: StatDatum = {
  ...
  subtitle: "Labour markets stable but slowing",
  renderType: "metric",
  value: "72.1%",
  valueContext: "OECD average employment rate (Q1 2025)",
  items: [
    { text: "Unemployment stable at 4.9% across OECD" },
    { text: "Real wages growing in 33 of 37 OECD countries" },
    { text: "Average real wage growth: 2.5% (Q1 2025)" },
    { text: "Demographic crunch: aging populations key challenge" },
  ] as BulletItem[],
  gradientColors: "from-blue-400 via-indigo-500 to-blue-400",
  iconColor: "text-blue-600",
  provenance: oecdLabour,
...
const card97_mcKinseyEuropeTransitions: StatDatum = {
  ...
  note: "AI fluency demand up 7× since 2023. Most skills endure but will be applied differently alongside AI.",
...
const card102_aiProductivityBoost: StatDatum = {
  ...
  renderType: "metric",
  value: "$2.9T",
  valueContext: "annual value from AI agents & robots (U.S. alone)",
  items: [
    { text: "57% of U.S. work hours technically automatable" },
    { text: "AI fluency demand up 7× since 2023" },
    { text: "70%+ of skills used in both automatable and non-automatable work" },
    { text: "Future = partnerships among people, agents, and robots" },
  ] as BulletItem[],
  gradientColors: "from-emerald-400 via-teal-500 to-cyan-400",
  iconColor: "text-emerald-600",
  provenance: mckinsey,
...
const card105_norwayStartupUnicorns: StatDatum = {
  ...
  note: "~16,882 total startups. 3,380 funded ($45.1B raised). 5 unicorns worth $5.7B combined.",
  gradientColors: "from-cyan-400 via-blue-500 to-indigo-400",
  iconColor: "text-cyan-600",
  provenance: navSsb,
};
