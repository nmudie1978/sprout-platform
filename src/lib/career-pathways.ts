...
export const CAREER_PATHWAYS: Record<CareerCategory, Career[]> = {
  ...
  MANUFACTURING_ENGINEERING: [
    ...
    { id: "space-mission-planner", title: "Space Mission Planner", emoji: "🗺️", description: "Plan missions end-to-end — orbits, timelines, contingencies, and crew/instrument schedules.", avgSalary: "800,000 - 1,250,000 kr/year", educationPath: "Master's in Aerospace or Astrodynamics + mission ops experience", keySkills: ["mission design", "orbital mechanics", "scheduling", "risk analysis", "coordination"], dailyTasks: ["Design mission profiles", "Schedule operations", "Run trajectory studies", "Brief stakeholders", "Plan contingencies"], growthOutlook: "medium" },
    { id: "ground-control-operator", title: "Ground Control Operator", emoji: "🖥️", description: "Monitor and command spacecraft from a ground control centre — tracking telemetry and uplinking commands 24/7.", avgSalary: "600,000 - 900,000 kr/year", educationPath: "Bachelor's in Aerospace, Engineering, or Physics + on-site training", keySkills: ["calm focus", "telemetry analysis", "radio comms", "shift work", "procedures"], dailyTasks: ["Monitor telemetry", "Send commands", "Log anomalies", "Coordinate handovers", "Support recovery"], growthOutlook: "medium" },
    { id: "flight-dynamics-engineer", title: "Flight Dynamics Engineer", emoji: "📐", description: "Compute and refine spacecraft trajectories, manoeuvres, and orbital insertions throughout a mission.", avgSalary: "800,000 - 1,300,000 kr/year", educationPath: "Master's/PhD in Aerospace or Astrodynamics", keySkills: ["orbital mechanics", "numerical methods", "modelling", "MATLAB/Python", "precision"], dailyTasks: ["Model trajectories", "Plan burns", "Compute manoeuvres", "Validate ephemeris", "Support flight ops"], growthOutlook: "medium" },
    { id: "astrophysicist", title: "Astrophysicist", emoji: "🌌", description: "Study the universe — stars, galaxies, dark matter — using telescopes, satellites, and theoretical models.", avgSalary: "650,000 - 1,100,000 kr/year", educationPath: "PhD in Astrophysics or Physics", keySkills: ["physics", "data analysis", "modelling", "research writing", "python"], dailyTasks: ["Run simulations", "Analyse observations", "Write papers", "Collaborate internationally", "Teach students"], growthOutlook: "medium" },
