  ...
  ARTIFICIAL_INTELLIGENCE: [
    {
      ...
      title: "AI Engineer",
      emoji: "🤖",
      description: "Build production AI systems that solve real problems — design, train, and deploy machine learning models using data and research-backed methods.",
      avgSalary: "750,000 - 1,200,000 kr/year",
      educationPath: "Bachelor's/Master's in Computer Science, AI, or Machine Learning (3-5 years)",
      keySkills: ["Python", "machine learning", "neural networks", "research", "data analysis", "mathematics"],
      dailyTasks: ["Analyse data", "Design AI models", "Train and optimise algorithms", "Deploy models to production", "Evaluate performance"],
      growthOutlook: "high",
      lastVerifiedAt: "2026-04-16",
    },
    {
    ...
    },
    {
      ...
      keySkills: ["system design", "cloud architecture", "machine learning", "communication", "leadership", "business acumen"],
      dailyTasks: ["Design AI architectures", "Evaluate technology choices", "Consult with stakeholders", "Guide engineering teams", "Document blueprints"],
      growthOutlook: "high",
    ...
    },
    {
      ...
      keySkills: ["large language models", "writing", "evaluation", "critical thinking", "creativity", "experimentation"],
      dailyTasks: ["Design prompts", "Test model outputs", "Build prompt libraries", "Analyse failure modes", "Document best practices"],
      growthOutlook: "high",
      entryLevel: true,
      lastVerifiedAt: "2026-04-16",
    },
    {
      ...
      keySkills: ["generative models", "Python", "large language models", "diffusion models", "API integration", "product thinking"],
      dailyTasks: ["Integrate generative models", "Build AI features", "Fine-tune models", "Manage model costs", "Ship to users"],
      growthOutlook: "high",
      lastVerifiedAt: "2026-04-16",
    },
    {
