...
export const CAREER_PATHWAYS: Record<CareerCategory, Career[]> = {
  ...
  HEALTHCARE_LIFE_SCIENCES: [
    ...
    { id: "biomedical-engineer", title: "Biomedical Engineer", emoji: "🦾", description: "Design the technology that saves lives — from MRI scanners and pacemakers to prosthetics and surgical robots, blending engineering with medicine.", avgSalary: "600,000 - 950,000 kr/year", educationPath: "Master's in Biomedical Engineering (5 years)", keySkills: ["engineering", "problem-solving", "biology knowledge", "maths", "creativity"], dailyTasks: ["Design medical devices", "Test and refine prototypes", "Work with clinicians", "Ensure safety standards", "Solve technical problems"], growthOutlook: "high", workSetting: "mixed", peopleIntensity: "medium", entryRoute: "master", gradeBand: { floor: 4, ceiling: 5, competitiveness: "competitive" } },
