...
const SUBJECT_CATEGORY_WEIGHTS: Record<string, Partial<Record<CareerCategory, number>>> = {
  ...
  music:        { CREATIVE_MEDIA: 3, EDUCATION_TRAINING: 1, HOSPITALITY_TOURISM: 1 },
  ...
  "design-tech":   { CREATIVE_MEDIA: 2, MANUFACTURING_ENGINEERING: 3, TECHNOLOGY_IT: 1, HOSPITALITY_TOURISM: 1 },
