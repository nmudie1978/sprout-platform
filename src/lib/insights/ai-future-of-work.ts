  ...
  videos: {
    ...
    items: [
      ...
      },
      {
        ...
        title: "Day in the Life of an AI Engineer",
        channel: "Springboard",
        blurb: "Inside the routine of an AI engineer — data, models and teamwork.",
      },
      {
        id: "d8bS3VBGE5k",
        title: "A Day in the Life of a Machine Learning Engineer",
        channel: "Simplilearn",
        blurb: "What an ML engineer actually does day to day, and the skills it takes.",
      },
      {
        id: "iKezixQ7lAw",
        title: "A Day in the Life of a Machine Learning Engineer (Berlin)",
        channel: "Boris Meinardus",
        blurb: "An honest look at ML engineering work at a startup in Berlin.",
      },
      {
        id: "T1QOf1GfGuI",
        title: "Day in the Life of a Data Scientist in San Francisco",
        channel: "edrea",
        blurb: "A real day working as a data scientist at a tech company.",
      },
      {
        id: "E1pNOqyq8s8",
        title: "What Is a Data Scientist? A Day in the Life",
        channel: "Damsel in Data",
        blurb: "What data scientists do, and how the role fits the wider industry.",
      },
      {
        id: "WY5I1VfIZZg",
        title: "A Day in the Life of a Data Scientist (Databricks)",
