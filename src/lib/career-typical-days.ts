...
const careerDetailsMap: Record<string, CareerDetails> = {
  ...
  "doctor": {
    ...
    entryPaths: [
      ...
      "Specialisation training (3-6 years)",
  ...
  "dentist": {
    ...
    entryPaths: [
      ...
      "Authorisation from health authorities",
      "Optional: Specialisation (3+ years)",
    ],
  ...
  "physiotherapist": {
    ...
    entryPaths: [
      ...
      "Optional: Master's or specialisation",
    ],
  ...
  "psychologist": {
    typicalDay: {
      ...
      environment: "Private practice, hospital, school, or organisation (regular hours, some flexibility)",
    },
    whatYouActuallyDo: [
  ...
  "data-analyst": {
    typicalDay: {
      ...
      midday: [
        ...
        "Build or update data visualisations",
  ...
  "cybersecurity-analyst": {
    ...
    entryPaths: [
      ...
      "Start in IT support or network administration",
      "Gain 2-3 years of hands-on IT experience",
      "Security certifications (CompTIA Security+, then CISSP or CEH)",
      "Progress to security analyst or engineer role",
    ],
    realityCheck: "Constant vigilance required. Attackers evolve faster than defences. Can be stressful during incidents. But protecting organisations is rewarding.",
  },
  ...
  "cloud-engineer": {
    ...
    entryPaths: [
      ...
      "Start in IT support, sysadmin, or developer role",
      "Gain 2-3 years of hands-on infrastructure experience",
      "Cloud certifications (AWS, Azure, or GCP) after work experience",
      "Progress to cloud engineer or architect role",
    ],
  ...
  "devops-engineer": {
    ...
    entryPaths: [
      ...
      "Learn containerisation and CI/CD tools",
  ...
  "it-project-manager": {
    ...
    entryPaths: [
      ...
      "Start as technical team member, developer, or coordinator",
      "Gain 3-5 years of hands-on work experience",
      "PMP or PRINCE2 certification (after work experience)",
      "Progress to project manager role",
      "Agile certifications (CSM, SAFe) to broaden your approach",
    ],
  ...
  "cio": {
    ...
    realityCheck: "Enormous responsibility and pressure. Always accountable for failures. But opportunity to shape organisation's technology future.",
  },
  ...
  "agile-coach": {
    ...
    whatYouActuallyDo: [
      "Guide organisations in agile adoption",
    ...
    realityCheck: "Change is slow. Organisations resist. Success hard to measure directly. But deeply satisfying to transform team cultures.",
  },
  ...
  "database-administrator": {
    ...
    realityCheck: "On-call for critical systems. Blamed when database slow. But essential role with good job security and interesting optimisation challenges.",
  },
  ...
  "graphic-designer": {
    typicalDay: {
      ...
      afternoon: [
        ...
        "Admin tasks and file organisation",
      ],
  ...
  "accountant": {
    ...
    entryPaths: [
      ...
      "Authorisation as regnskapsfører",
  ...
  "auditor": {
    ...
    entryPaths: [
      ...
      "State authorisation (statsautorisert revisor)",
  ...
  "digital-marketer": {
    typicalDay: {
      ...
      environment: "Office or remote, fast-paced with constant optimisation",
    },
    whatYouActuallyDo: [
  ...
  "enterprise-architect": {
    ...
    realityCheck: "Very political role. Lots of meetings and documentation. Impact is long-term and indirect. But shapes entire organisation's technology direction.",
  },
  ...
  "beautician": {
    typicalDay: {
      ...
      tools: ["Skincare equipment", "Makeup products", "Sterilisation tools", "Treatment beds", "Lighting"],
  ...
  "nail-technician": {
    typicalDay: {
      ...
      tools: ["Nail files and buffers", "UV lamps", "Gel/acrylic supplies", "Sterilisation equipment", "Nail art tools"],
  ...
  "growth-marketing-director": {
    typicalDay: {
      ...
      tools: ["Google Analytics / Amplitude", "Google Ads / Meta Ads Manager", "Optimisely or VWO", "Mixpanel or Heap", "SQL / dbt"],
  ...
  "pharmaceutical-program-director": {
    typicalDay: {
      morning: ["Portfolio prioritisation review", "Cross-functional program team standup", "Regulatory milestone tracking"],
    ...
    whatYouActuallyDo: [
      "You drive entire drug development programs from early development through commercialisation, integrating clinical, regulatory, manufacturing, and commercial workstreams into a cohesive strategy.",
  ...
  "healthtech-product-director": {
    typicalDay: {
      ...
      midday: ["Clinical workflow mapping with hospital stakeholders", "Regulatory compliance check for medical device software", "Roadmap prioritisation"],
  ...
  "senior-software-engineer": {
    ...
    topSkills: ["System design", "Code quality and testing", "Performance optimisation", "Technical communication", "Debugging complex systems"],
  ...
  "cloud-architect": {
    typicalDay: {
      morning: ["Review cloud cost optimisation reports", "Architecture review board meeting", "Security posture assessment"],
    ...
    whatYouActuallyDo: [
      "You design and govern cloud infrastructure strategies that balance cost, security, performance, and compliance, making decisions that affect how the entire organisation builds and deploys software.",
    ...
    topSkills: ["Cloud platform expertise (AWS/Azure/GCP)", "Infrastructure as Code", "Security and compliance", "Cost optimisation", "Solution architecture"],
    entryPaths: ["Senior DevOps or infrastructure engineer advancing to architecture", "Solutions architect at a cloud provider", "Enterprise architect adding deep cloud specialisation"],
  ...
  "infrastructure-architect": {
    ...
    whatYouActuallyDo: [
      "You design the foundational technology infrastructure that applications run on, encompassing compute, storage, networking, and hybrid cloud strategies for the organisation.",
    ...
    realityCheck: "Infrastructure decisions have multi-year consequences and are expensive to reverse; expect thorough review processes and slow organisational change.",
  },
  "senior-sre": {
    typicalDay: {
  ...
  "senior-devops-engineer": {
    typicalDay: {
      ...
      afternoon: ["Developer experience improvements", "Cost monitoring and optimisation", "Knowledge sharing session"],
    ...
    whatYouActuallyDo: [
      ...
      "Norwegian companies increasingly adopt platform engineering approaches, and DevOps engineers here often work across small, cross-functional teams in flat organisational structures.",
    ],
  ...
  "security-architect": {
    ...
    whatYouActuallyDo: [
      "You design the security architecture for an organisation, defining how systems, networks, and data are protected through technical controls, policies, and frameworks.",
  ...
  "application-security-lead": {
    typicalDay: {
      ...
      midday: ["Developer security training session", "Vulnerability prioritisation meeting", "Security champion program coordination"],
  ...
  "senior-network-architect": {
    typicalDay: {
      morning: ["Network topology review", "BGP peering optimisation", "SD-WAN strategy planning"],
  ...
  "systems-architect": {
    ...
    whatYouActuallyDo: [
      ...
      "In Norway's enterprise landscape, systems architects work across sectors like public administration (Altinn), banking, and energy, often managing complex legacy modernisation programs.",
    ],
  ...
  "senior-data-engineer": {
    typicalDay: {
      ...
      midday: ["Design new data pipeline for analytics team", "Optimise query performance", "Schema evolution planning"],
    ...
    whoThisIsGoodFor: ["Engineers who enjoy building reliable, scalable systems", "People who like making data accessible to others", "Those who enjoy pipeline architecture and optimisation", "Problem solvers comfortable with messy real-world data"],
  ...
  "machine-learning-engineer": {
    typicalDay: {
      ...
      afternoon: ["MLOps infrastructure improvements", "Model serving optimisation", "Documentation and reproducibility work"],
    ...
    whatYouActuallyDo: [
      ...
      "In the Nordics, ML engineers work across recommendation systems (Schibsted), autonomous shipping (Kongsberg), energy optimisation (Equinor), and fintech fraud detection.",
    ],
    ...
    entryPaths: ["Software engineer adding ML specialisation", "Data scientist learning production engineering", "CS/ML graduate with strong engineering fundamentals"],
  ...
  "applied-ai-engineer": {
    typicalDay: {
      ...
      afternoon: ["Safety and bias evaluation", "Demo to product stakeholders", "Cost optimisation for inference"],
  ...
  "senior-data-scientist": {
    ...
    whatYouActuallyDo: [
      "You use statistical methods and machine learning to extract insights from data, build predictive models, and help organisations make better decisions based on evidence rather than intuition.",
      "In Norway, data scientists work in energy forecasting, fisheries optimisation, financial risk modeling, and public health analytics, often with high-quality Nordic registry data.",
    ],
    ...
    topSkills: ["Statistical modeling", "Machine learning", "Data visualisation", "Experimental design", "Business problem framing"],
  ...
  "principal-data-scientist": {
    typicalDay: {
      ...
      environment: "Senior technical leadership position in a large organisation, with significant influence on strategy and direction.",
    },
    whatYouActuallyDo: [
      "You set the technical vision for data science across the organisation, tackle the hardest problems personally, and multiply impact by raising the bar for the entire data science function.",
    ...
    topSkills: ["Advanced statistical methods", "Strategic thinking", "Technical leadership", "Research to production translation", "Organisational influence"],
    entryPaths: ["Senior data scientist with proven organisational impact", "Research scientist with industry experience", "Data science manager returning to technical track"],
    realityCheck: "You're expected to be both the smartest person in the room technically and a skilled organisational influencer; balancing both is genuinely difficult.",
  },
  ...
  "quant-developer": {
    typicalDay: {
      morning: ["Optimise model execution performance", "Deploy updated pricing libraries", "Review production model outputs"],
    ...
    whoThisIsGoodFor: ["Programmers who love performance optimisation", "People who enjoy financial mathematics applications", "Engineers who care about correctness and precision", "Those who like working at the intersection of math and code"],
  ...
  "decision-science-lead": {
    ...
    whatYouActuallyDo: [
      "You use data, experimentation, and analytical frameworks to help organisations make better strategic decisions, going beyond descriptive analytics to causal understanding and prescriptive recommendations.",
      "In Norwegian companies, decision science leads often support pricing strategy, market expansion decisions, and operational optimisation in sectors like telecom (Telenor), retail, and energy.",
    ],
    ...
    realityCheck: "Your recommendations are only valuable if leaders act on them; influencing organisational decisions requires as much persuasion as analytical skill.",
  },
  "engineering-manager": {
    typicalDay: {
  ...
  "senior-engineering-manager": {
    typicalDay: {
      morning: ["Leadership team standup", "Review organisational health metrics", "Manager coaching session"],
      ...
      environment: "Managing multiple engineering teams (typically 2-4 teams), with more organisational and strategic responsibilities than a single-team manager.",
    },
    whatYouActuallyDo: [
      "You manage engineering managers and multiple teams, focusing on organisational design, cross-team effectiveness, and translating business strategy into engineering execution.",
      "In Norwegian tech organisations, this role requires navigating consensus-driven decision-making culture while still driving accountability and delivery across teams.",
    ],
    whoThisIsGoodFor: ["Experienced managers who want broader organisational impact", "People skilled at developing other leaders", "Strategic thinkers who enjoy organisational design", "Those comfortable with ambiguity and politics"],
    topSkills: ["Organisational leadership", "Manager development", "Strategic planning", "Budget management", "Cross-functional collaboration"],
    entryPaths: ["Engineering manager with multiple years of team leadership", "Senior engineer with leadership aptitude in growing organisation", "Product or program manager transitioning to engineering leadership"],
    realityCheck: "You're further from the code and closer to organisational politics; success is measured by your teams' outcomes, not your individual contributions.",
  },
  "director-of-engineering": {
    typicalDay: {
      morning: ["Executive leadership meeting", "Engineering OKR review", "Organisational structure planning"],
    ...
    whatYouActuallyDo: [
      "You lead an entire engineering department or major division, setting technical direction, building organisational culture, managing budgets, and aligning engineering output with company strategy.",
    ...
    whoThisIsGoodFor: ["Experienced leaders ready for department-level responsibility", "Strategic thinkers who can operate at executive level", "People who enjoy building and scaling organisations", "Those who can balance technical vision with business needs"],
    topSkills: ["Organisational leadership", "Strategic planning", "Executive communication", "Technical vision", "Talent strategy"],
    entryPaths: ["Senior engineering manager with proven scaling experience", "VP Engineering at smaller company moving to larger organisation", "CTO of startup transitioning to director at scale-up"],
  ...
  "vp-engineering": {
    typicalDay: {
      ...
      environment: "Executive suite with responsibility for the entire engineering organisation, frequent travel for board meetings, conferences, and customer visits.",
    },
    whatYouActuallyDo: [
      "You own the engineering organisation's strategy, budget, and execution at the executive level, representing engineering in C-suite decisions and ensuring technology capabilities support the company's business objectives.",
    ...
    whoThisIsGoodFor: ["Senior leaders who think in terms of organisational systems", "Executives comfortable with P&L responsibility", "Those who can represent technology to boards and investors", "People who enjoy building world-class engineering cultures"],
    topSkills: ["Executive leadership", "Budget and P&L management", "Technology strategy", "Board communication", "Organisational design"],
  ...
  "head-of-engineering": {
    typicalDay: {
      ...
      midday: ["Architecture governance meeting", "Cross-departmental priority alignment", "Team structure optimisation"],
    ...
    whatYouActuallyDo: [
      ...
      "In Norwegian companies, heads of engineering often take a hands-on approach in smaller organisations and a more strategic role in larger ones, always within the context of Nordic flat hierarchy expectations.",
    ],
  ...
  "technical-director": {
    typicalDay: {
      ...
      midday: ["Technical debt prioritisation across teams", "Platform strategy discussion", "Technical community of practice facilitation"],
      ...
      environment: "Senior technical leadership role focused on technical excellence rather than people management, often working across the entire engineering organisation.",
    },
    whatYouActuallyDo: [
      "You set the technical direction for the engineering organisation, making key architectural and technology decisions, driving technical excellence, and ensuring the codebase and systems can support future business needs.",
      "In Nordic tech companies, technical directors often serve as the senior-most individual contributor path, providing an alternative to management for those who want to stay deeply technical while having organisational impact.",
    ],
    whoThisIsGoodFor: ["Deep technologists who want organisational influence", "People who prefer technical leadership over people management", "Those who enjoy setting standards and best practices", "Engineers who want to shape technology strategy"],
  ...
  "technology-director": {
    typicalDay: {
      ...
      environment: "Senior leadership role in a large enterprise or public sector organisation, bridging business strategy and technology implementation.",
    },
    whatYouActuallyDo: [
      "You lead the overall technology strategy for an organisation, encompassing software engineering, infrastructure, data, and digital transformation, ensuring technology investments align with business objectives.",
      "In Norway, technology directors in public sector (NAV, Skatteetaten) and large enterprises (Equinor, Telenor) manage complex modernisation programs while navigating procurement regulations and stakeholder expectations.",
    ],
    whoThisIsGoodFor: ["Business-minded technologists", "Leaders who enjoy enterprise-scale transformation", "People who can manage large budgets and vendor relationships", "Those comfortable in highly matrixed organisations"],
    topSkills: ["Technology strategy", "Digital transformation", "Budget and vendor management", "Enterprise architecture", "Organisational leadership"],
    ...
    realityCheck: "This is as much about organisational change management and politics as it is about technology; pure technologists often struggle in this role.",
  },
  ...
  "chief-digital-officer": {
    ...
    whatYouActuallyDo: [
      "You drive the organisation's digital strategy, ensuring all customer-facing and internal digital channels deliver value and competitive advantage.",
    ...
    realityCheck: "You need to show measurable digital ROI quickly, and many organisations still struggle to define what 'digital' actually means at the executive level.",
  },
  "senior-product-manager": {
    typicalDay: {
      morning: ["Analyse user metrics and A/B test results", "Prioritize backlog with engineering", "Conduct stakeholder alignment meetings"],
  ...
  "principal-product-manager": {
    typicalDay: {
      ...
      midday: ["Lead product council or review meetings", "Align product vision with company strategy", "Analyse market trends and competitive threats"],
      afternoon: ["Resolve escalated prioritisation conflicts", "Drive alignment across engineering and design", "Present strategy to leadership"],
  ...
  "group-product-manager": {
    ...
    whoThisIsGoodFor: ["PMs who love developing other PMs", "People who enjoy organisational challenges", "Leaders who can context-switch between strategy and coaching", "Those who find satisfaction in team success over personal output"],
    topSkills: ["People management", "Product strategy", "Coaching and mentoring", "Organisational design", "Conflict resolution"],
  ...
  "director-of-product": {
    typicalDay: {
      ...
      afternoon: ["Present to C-suite on product performance", "Manage product organisation structure", "Define hiring strategy for product team"],
    ...
    whoThisIsGoodFor: ["Strategic leaders with product depth", "People comfortable with P&L responsibility", "Those who enjoy building product organisations", "Leaders who balance customer advocacy with business results"],
    topSkills: ["Product vision", "P&L management", "Organisational leadership", "Go-to-market strategy", "Executive communication"],
  ...
  "vp-product": {
    typicalDay: {
      ...
      afternoon: ["Board presentation preparation", "Investor or customer executive meetings", "Organisational planning and hiring"],
    ...
    whoThisIsGoodFor: ["Ambitious product leaders who want executive impact", "People who thrive on business strategy and market dynamics", "Leaders comfortable presenting to boards and investors", "Those who can build and scale product organisations"],
    topSkills: ["Executive leadership", "Business strategy", "Product vision", "Investor communication", "Organisational scaling"],
  ...
  "head-of-product": {
    typicalDay: {
      ...
      midday: ["Lead product team all-hands or guild meetings", "Drive prioritisation across product areas", "Meet with key customers or partners"],
      afternoon: ["Coach product managers and leads", "Present roadmap to CEO or leadership", "Plan product organisation growth"],
      tools: ["Jira", "Amplitude", "Figma", "Notion"],
      environment: "Hybrid work combining strategic planning, team leadership, and stakeholder management across the organisation.",
    },
    whatYouActuallyDo: [
      ...
      "In Norwegian scale-ups and mid-size companies, this is often the top product role, combining hands-on product leadership with organisational building.",
    ],
    whoThisIsGoodFor: ["Product leaders who want to build a function from scratch", "People who balance strategic vision with tactical execution", "Leaders who enjoy hiring and developing talent", "Those who thrive in fast-growing organisations"],
  ...
  "product-strategy-lead": {
    typicalDay: {
      morning: ["Analyse market data and competitive intelligence", "Define strategic positioning for product lines", "Meet with product and business leadership"],
  ...
  "technical-director-gaming": {
    ...
    whoThisIsGoodFor: ["Deep technologists who love games", "Engineers who enjoy architecture-level decisions", "People who can bridge creative vision and technical constraints", "Those who thrive on performance optimisation challenges"],
    topSkills: ["Game engine architecture", "Performance optimisation", "Technical leadership", "Cross-discipline communication", "R&D evaluation"],
  ...
  "studio-director": {
    ...
    whoThisIsGoodFor: ["Business-minded leaders passionate about games", "People who enjoy building organisations and culture", "Leaders comfortable with financial accountability", "Those who can manage creative talent with empathy"],
  ...
  "platform-director-media": {
    typicalDay: {
      ...
      midday: ["Evaluate content delivery and streaming infrastructure", "Drive ad tech or subscription model optimisation", "Meet with technology and design leaders"],
  ...
  "product-director-consumer": {
    typicalDay: {
      morning: ["Review consumer metrics and funnel data", "Align product teams on growth priorities", "Analyse user segmentation and behavior"],
      ...
      tools: ["Amplitude", "Optimisely", "Figma", "Mixpanel"],
    ...
    whoThisIsGoodFor: ["Data-driven product leaders who love consumer behavior", "People who thrive on rapid experimentation", "Leaders who understand growth loops and viral mechanics", "Those who enjoy balancing user delight with monetisation"],
    topSkills: ["Product-led growth", "Consumer analytics", "UX strategy", "A/B testing", "Monetisation strategy"],
  ...
  "program-director": {
    typicalDay: {
      ...
      environment: "Large organisation setting with formal governance, steering committees, and cross-functional team coordination.",
    },
    whatYouActuallyDo: [
      ...
      "In Norway, program directors are in demand across public sector digitalisation, oil and gas transformations, and large enterprise IT modernisation efforts.",
    ],
  ...
  "transformation-director": {
    typicalDay: {
      morning: ["Review transformation KPIs and adoption metrics", "Align with C-suite on transformation vision", "Assess organisational readiness for change"],
      ...
      environment: "Executive-level role with heavy stakeholder engagement, workshops, and organisational change management across the enterprise.",
    },
    whatYouActuallyDo: [
      "You lead enterprise-wide transformation initiatives, fundamentally changing how an organisation operates through technology, process, and culture change.",
      "In Norway, transformation directors are critical in industries like energy, banking, and public sector, where digitalisation requires deep organisational change.",
    ],
    whoThisIsGoodFor: ["Change leaders who can navigate organisational politics", "People who combine technology understanding with people skills", "Leaders comfortable with multi-year timelines and ambiguity", "Those who enjoy redesigning how organisations work"],
    topSkills: ["Transformation strategy", "Change management", "Organisational design", "Executive communication", "Benefits realisation"],
  ...
  "digital-transformation-lead": {
    typicalDay: {
      ...
      midday: ["Drive cloud migration and platform modernisation", "Lead digital capability building workshops", "Evaluate digital tools and vendor solutions"],
    ...
    whatYouActuallyDo: [
      "You drive the practical execution of digital transformation, helping organisations adopt new technologies, processes, and ways of working.",
    ...
    whoThisIsGoodFor: ["Pragmatic technologists with change management skills", "People who enjoy bridging business and IT", "Leaders who can simplify complex transformation into actionable steps", "Those who thrive on making organisations more digital-savvy"],
    ...
    entryPaths: ["IT manager leading digitalisation projects", "Management consultant specializing in digital", "Product or delivery lead expanding to transformation"],
  ...
  "technology-transformation-lead": {
    typicalDay: {
      morning: ["Review technology modernisation progress", "Align architecture decisions with transformation goals", "Meet with enterprise architects and platform teams"],
    ...
    whatYouActuallyDo: [
      ...
      "In Norwegian enterprises like Equinor, DNB, or Posten, this role bridges enterprise architecture with hands-on delivery of technology modernisation programs.",
    ],
    ...
    topSkills: ["Enterprise architecture", "Cloud migration", "Legacy modernisation", "Vendor management", "Technical program management"],
  ...
  "portfolio-director": {
    typicalDay: {
      ...
      afternoon: ["Track portfolio-level benefits realisation", "Manage dependencies between programs", "Report to executive committee on portfolio status"],
    ...
    whatYouActuallyDo: [
      "You manage an organisation's project and program portfolio, ensuring investments are strategically aligned and resources are optimally allocated.",
      "In Norway, portfolio directors work in large enterprises and public sector organisations managing hundreds of millions in annual project investments.",
    ],
    whoThisIsGoodFor: ["Strategic thinkers who love investment optimisation", "People comfortable making tough prioritisation calls", "Leaders who enjoy governance and structured decision-making", "Those who can see the big picture across many initiatives"],
    topSkills: ["Portfolio management", "Investment prioritisation", "Resource optimisation", "Governance design", "Benefits management"],
  ...
  "delivery-director": {
    typicalDay: {
      ...
      midday: ["Lead delivery leadership team meetings", "Optimise team capacity and staffing", "Drive process improvement and delivery maturity"],
  ...
  "senior-project-director": {
    ...
    whatYouActuallyDo: [
      "You lead the most complex and strategically important projects in an organisation, typically with budgets in the hundreds of millions NOK.",
      "In Norway, senior project directors manage critical infrastructure, public sector digitalisation, or major enterprise system implementations.",
    ],
    ...
    realityCheck: "The bigger the project, the more likely it will face delays and cost overruns — your job is to minimise the damage when things go wrong.",
  },
  "senior-management-consultant": {
    typicalDay: {
      morning: ["Structure client problem and develop hypothesis", "Analyse data and build recommendation frameworks", "Prepare client workshop materials"],
    ...
    whatYouActuallyDo: [
      "You solve complex business problems for clients, combining analytical rigor with stakeholder management to drive strategic decisions and organisational change.",
  ...
  "principal-consultant": {
    ...
    whatYouActuallyDo: [
      "You are a recognised expert who leads complex engagements, develops client relationships, and shapes your consulting firm's offerings and reputation.",
    ...
    realityCheck: "You're expected to sell your own work and deliver it at the same time — utilisation targets and revenue pressure never stop.",
  },
  "consulting-partner": {
    typicalDay: {
      morning: ["Meet with prospective clients on new opportunities", "Set strategic direction for consulting practice", "Review P&L and utilisation metrics"],
  ...
  "transformation-consultant": {
    ...
    whatYouActuallyDo: [
      "You guide organisations through large-scale change, designing and executing transformation programs that span technology, processes, and people.",
      "In Norway, transformation consultants are heavily in demand for energy transition, public sector modernisation, and financial services digitalisation.",
    ],
    whoThisIsGoodFor: ["People who enjoy fixing how organisations work", "Empathetic leaders who understand human resistance to change", "Systems thinkers who connect technology and organisational design", "Those comfortable with long, complex engagements"],
    topSkills: ["Transformation design", "Change management", "Operating model design", "Stakeholder engagement", "Benefits realisation"],
    entryPaths: ["Management consultant specializing in transformation", "Internal change leader moving to consulting", "Project manager expanding to organisational change"],
    realityCheck: "Transformations are messy and slow — you'll need patience and resilience because organisational change takes years, not months.",
  },
  "technology-strategy-consultant": {
    ...
    whatYouActuallyDo: [
      "You help organisations make strategic technology decisions — which platforms to invest in, how to modernize, and how to align IT with business goals.",
  ...
  "enterprise-systems-consultant": {
    typicalDay: {
      morning: ["Gather business requirements from stakeholders", "Map processes to enterprise system capabilities", "Configure and customise system modules"],
    ...
    whatYouActuallyDo: [
      "You implement and optimise enterprise systems like SAP, Oracle, or Dynamics 365, translating business needs into system configuration and process design.",
  ...
  "erp-transformation-lead": {
    ...
    whatYouActuallyDo: [
      "You lead the end-to-end transformation of an organisation's ERP system, which touches every business process from finance to supply chain.",
    ...
    whoThisIsGoodFor: ["Leaders who thrive on complex, high-stakes programs", "People who understand both business processes and enterprise technology", "Those comfortable managing large teams and vendor relationships", "Leaders who can navigate organisational politics at every level"],
    topSkills: ["ERP implementation", "Business process transformation", "Program management", "Vendor management", "Change management"],
    entryPaths: ["Enterprise systems consultant with leadership experience", "Program director specializing in ERP", "IT director leading their organisation's ERP program"],
  ...
  "oss-bss-transformation-lead": {
    typicalDay: {
      morning: ["Review OSS/BSS modernisation program status", "Align with network and IT architecture teams", "Assess vendor platform capabilities and roadmaps"],
    ...
    whatYouActuallyDo: [
      "You lead the modernisation of telecom operations and business support systems, enabling operators to launch new services and improve customer experience.",
  ...
  "fractional-cto": {
    typicalDay: {
      morning: ["Review technical architecture decisions for client A", "Lead sprint planning with distributed dev team", "Assess cloud infrastructure costs and optimisation"],
  ...
  "fractional-cio": {
    typicalDay: {
      ...
      environment: "Split between home office and client sites. Typically serves 2-3 organisations simultaneously, often in different industries.",
    },
    whatYouActuallyDo: [
      ...
      "Norwegian mid-market companies and public sector organisations increasingly use fractional CIOs to navigate digitalisation, cloud migration, and compliance with regulations like Schrems II.",
    ],
    ...
    topSkills: ["IT governance", "Digital transformation", "Vendor management", "Cybersecurity oversight", "Budgeting and cost optimisation"],
  ...
  "general-manager": {
    ...
    whatYouActuallyDo: [
      ...
      "In Norway, general managers balance the flat organisational culture with clear accountability, often managing both Norwegian and international teams in companies like Aker, Kongsberg, or regional enterprises.",
    ],
  ...
  "business-unit-director": {
    typicalDay: {
      morning: ["Analyse monthly revenue and margin reports", "Strategic alignment call with group CEO", "Review market intelligence and competitor moves"],
    ...
    whoThisIsGoodFor: ["Ambitious leaders with entrepreneurial drive", "People comfortable with board-level accountability", "Strategic thinkers who also execute", "Those who thrive managing complex organisations"],
    topSkills: ["Strategic leadership", "Financial management", "Organisational design", "Market development", "Executive communication"],
  ...
  "managing-director": {
    typicalDay: {
      ...
      afternoon: ["Lead organisational change initiative", "One-on-ones with direct reports", "Prepare for board meeting"],
  ...
  "country-manager": {
    ...
    realityCheck: "You often have responsibility without full authority, caught between global standardisation and local adaptation, and HQ rarely understands Norwegian workplace dynamics.",
  },
  "regional-director": {
    typicalDay: {
  ...
  "operations-director": {
    ...
    whoThisIsGoodFor: ["Systematic thinkers who love optimisation", "Leaders who enjoy being close to the product or service", "People who thrive on solving practical problems daily", "Those who value measurable results"],
  ...
  "head-of-operations": {
    ...
    whatYouActuallyDo: [
      "You manage the operational backbone of the company, ensuring processes run smoothly, teams are effective, and the organisation scales without breaking.",
    ...
    whoThisIsGoodFor: ["Detail-oriented organisers who see the big picture", "People who enjoy building systems and processes", "Those who like making things run better every day", "Calm problem-solvers who handle chaos well"],
  ...
  "senior-legal-counsel": {
    ...
    whoThisIsGoodFor: ["Lawyers who want business impact over billable hours", "Strategic thinkers with commercial awareness", "People who enjoy being embedded in a business", "Those who prefer depth in one organisation over variety"],
  ...
  "general-counsel": {
    ...
    whatYouActuallyDo: [
      "You lead the entire legal function as the top lawyer in the organisation, serving on the executive team and advising the board on all legal, regulatory, and governance matters.",
  ...
  "head-of-legal": {
    ...
    whatYouActuallyDo: [
      "You lead a legal team in a mid-size organisation, combining hands-on legal work with team management, process improvement, and strategic advisory to leadership.",
    ...
    whoThisIsGoodFor: ["Lawyers who want leadership without losing the craft", "Generalists who enjoy breadth over specialisation", "People who like building teams and processes", "Those who want impact in a smaller organisation"],
    topSkills: ["Legal generalism", "Team leadership", "Process optimisation", "Commercial contracts", "Regulatory compliance"],
  ...
  "compliance-director": {
    ...
    whatYouActuallyDo: [
      "You build and lead the compliance function, ensuring the organisation meets all regulatory obligations, manages compliance risks, and fosters an ethical culture.",
  ...
  "regulatory-affairs-director": {
    ...
    entryPaths: ["Science or engineering degree followed by regulatory affairs specialisation", "Government regulator moving to industry", "Quality assurance professional transitioning to regulatory"],
  ...
  "risk-and-compliance-director": {
    ...
    whatYouActuallyDo: [
      "You lead the combined risk management and compliance function, ensuring the organisation identifies, assesses, and mitigates risks while meeting all regulatory requirements.",
  ...
  "data-protection-officer": {
    ...
    whatYouActuallyDo: [
      "You are the organisation's independent privacy expert, ensuring GDPR and Norwegian personopplysningsloven compliance, advising on data processing activities, and serving as the contact point for Datatilsynet.",
    ...
    whoThisIsGoodFor: ["Privacy-passionate professionals with legal or tech backgrounds", "Independent thinkers who can challenge the organisation", "Detail-oriented people who enjoy cross-functional work", "Those who value protecting individual rights"],
    topSkills: ["GDPR expertise", "Privacy impact assessment", "Data governance", "Incident response", "Stakeholder advisory"],
    entryPaths: ["Lawyer specializing in privacy and data protection", "IT security professional adding privacy specialisation", "CIPP/E certification combined with relevant experience"],
    realityCheck: "You must maintain independence while being employed by the organisation you oversee, and many companies still treat privacy as a checkbox rather than a strategic priority.",
  },
  "chief-people-officer": {
    typicalDay: {
      morning: ["Executive team meeting on organisational strategy", "Review employee engagement survey results", "Meet with board compensation committee"],
      ...
      environment: "Executive floor of a large organisation. Strategic role with high visibility and direct influence on company culture and talent decisions.",
    },
    whatYouActuallyDo: [
      "You lead the entire people function at the executive level, shaping culture, talent strategy, organisational design, and employee experience as a key member of the C-suite.",
    ...
    whoThisIsGoodFor: ["HR leaders who want strategic executive impact", "People who genuinely care about organisational culture", "Those who can balance empathy with tough decisions", "Leaders comfortable navigating unions and regulations"],
    topSkills: ["Organisational strategy", "Culture leadership", "Executive coaching", "Labor relations", "Talent management"],
    entryPaths: ["HR director promoted to C-suite", "Organisational psychologist transitioning to executive HR", "Management consultant specializing in people and organisation"],
  ...
  "hr-director": {
    ...
    topSkills: ["Norwegian labor law", "Talent management", "Compensation and benefits", "Union negotiation", "Organisational development"],
  ...
  "head-of-talent": {
    typicalDay: {
      ...
      afternoon: ["University partnership and early careers program planning", "Optimise ATS and recruitment technology stack", "Develop internal mobility framework"],
      tools: ["LinkedIn Recruiter", "Teamtailor/Workday Recruiting", "Culture Amp", "Assessment platforms", "Microsoft Teams"],
      environment: "Corporate or scale-up office. High-energy role connecting with candidates, hiring managers, and leadership across the organisation.",
    },
    whatYouActuallyDo: [
      "You lead talent acquisition and development strategy, ensuring the organisation attracts, hires, and retains the right people to achieve its goals.",
  ...
  "org-transformation-director": {
    typicalDay: {
      morning: ["Review transformation program status across workstreams", "Executive steering committee meeting", "Assess organisational readiness for change"],
      midday: ["Facilitate organisational design workshop", "Meet with change management team on communication plan", "Analyse employee feedback on transformation"],
      ...
      environment: "Project-based environment within a large organisation undergoing significant change. Heavy facilitation and stakeholder engagement.",
    },
    whatYouActuallyDo: [
      "You lead large-scale organisational transformations, redesigning structures, processes, and ways of working to achieve strategic objectives.",
    ...
    topSkills: ["Change management", "Organisational design", "Program management", "Stakeholder engagement", "Strategic communication"],
    entryPaths: ["Management consultant specializing in transformation", "HR leader with organisational development expertise", "Senior project manager moving into organisational change"],
  ...
  "workforce-strategy-director": {
    typicalDay: {
      morning: ["Analyse workforce data and future skills gaps", "Review workforce planning models", "Brief CHRO on strategic workforce insights"],
      ...
      tools: ["Visier/Workday Analytics", "Power BI", "Excel/Python", "LinkedIn Talent Insights", "Organisational network analysis tools"],
    ...
    whatYouActuallyDo: [
      "You lead the strategic planning of the organisation's workforce, using data and analytics to forecast talent needs, design workforce models, and close skills gaps.",
  ...
  "independent-program-director": {
    typicalDay: {
      ...
      environment: "Client site or remote. Embedded in client organisation for 6-18 month engagements. Operates as own business while leading large client programs.",
    },
    whatYouActuallyDo: [
      ...
      "In Norway, independent program directors are common in public sector digitalisation (e.g., NAV, Helse), energy transformation, and large corporate change programs.",
    ],
  ...
  "independent-transformation-lead": {
    typicalDay: {
      ...
      environment: "Client site or remote, embedded in the client organisation. Project-based engagements of 6-24 months. Self-employed through own AS.",
    },
    whatYouActuallyDo: [
      "You are an independent consultant who leads organisational transformations for clients, designing new operating models, driving change adoption, and ensuring the transformation delivers business value.",
    ...
    whoThisIsGoodFor: ["Experienced change leaders who want consulting freedom", "People who energize others through uncertainty", "Strategic thinkers with strong facilitation skills", "Those who build trust quickly across organisations"],
    topSkills: ["Transformation leadership", "Change management", "Operating model design", "Executive coaching", "Benefits realisation"],
  ...
  "investment-manager": {
    typicalDay: {
      morning: ["Review portfolio performance and market developments", "Investment committee preparation", "Analyse new investment opportunity"],
  ...
  "corporate-development-director": {
    ...
    realityCheck: "Deals take months to close and many fall apart, integration is where value is actually created or destroyed, and you must manage egos across both organisations.",
  },
  "ma-director": {
    typicalDay: {
  ...
  "offshore-production-technician": {
    typicalDay: {
      ...
      midday: ["Adjust choke valves to optimise well flow", "Monitor gas lift and injection systems", "Carry out first-line maintenance on production equipment"],
  ...
  "high-voltage-wind-technician": {
    ...
    entryPaths: ["Fagbrev as energimontør or elektriker with HV authorisation", "FSE (Forskrift om sikkerhet ved elektriske anlegg) certification", "Specialized HV courses from power industry or manufacturer"],
  ...
  "wind-commissioning-technician": {
    typicalDay: {
      morning: ["Review commissioning procedures and punch lists", "Perform pre-energisation checks on new turbine systems", "Verify sensor calibrations and control system settings"],
  ...
  "grid-connection-technician": {
    ...
    entryPaths: ["Fagbrev as energimontør or elektriker", "FSE authorisation for high-voltage work", "Additional training from grid operator or power company"],
  ...
  "ships-electrical-engineer": {
    typicalDay: {
      morning: ["Inspect main switchboard and generator synchronisation systems", "Review electrical maintenance schedule and prioritize tasks", "Test navigation and communication equipment"],
      ...
      tools: ["Multimeters and meggers", "Power quality analysers", "PLC programming tools", "Marine electrical drawing software"],
  ...
  "beauty-therapist": {
    typicalDay: {
      morning: [
        "Open salon — sanitise workspace, check stock, lay out sterile tools",
        "Review the day's appointment book, prep rooms per treatment",
        "Pre-heat wax pots and facial steamers for the first clients",
        "Greet first clients, run consultation + patch-test checks",
      ],
      midday: [
        "Deliver back-to-back treatments — facials, waxing, lash extensions, manicures",
        "Turn rooms between clients: strip beds, disinfect, restock",
        "Upsell relevant aftercare products at checkout",
        "Short lunch — the day rarely stops for long",
      ],
      afternoon: [
        "Longer-form appointments (body treatments, lash lift, brow lamination)",
        "Answer DMs and booking requests between clients",
        "End-of-day deep clean — sterilise tools, autoclave cycles, laundry",
        "Close out till, reconcile takings, restock used product",
      ],
      tools: [
        "Magnifying Lamps",
        "Facial Steamers",
        ...
        "Beauty Beds & Chairs",
        "Lash tweezers & glue",
        "Pedicure basin & files",
        "Product trolleys",
      ],
      environment: "Salon or spa room — bright, warm, scented. Physical work on your feet all day, with short gaps between clients. Strong focus on hygiene and client comfort.",
    },
    whatYouActuallyDo: [
      "Consult clients on goals, skin type, and contra-indications before every treatment",
      "Deliver facials, waxing, lash/brow work, manicures, pedicures, body treatments",
      "Maintain a meticulously clean and sterile workspace — this is the job",
      "Manage your own booking diary and build a loyal client base",
      "Advise on aftercare products and upsell where appropriate",
      "Keep up with new techniques (lash lifts, brow lamination, new waxes) via CPD courses",
    ],
    whoThisIsGoodFor: [
      "People who love working one-on-one and enjoy making others feel good",
      "Detail-oriented — precise hands and a steady eye matter",
      "Physically resilient — you stand most of the day",
      "Calm, warm communicators who put nervous clients at ease",
      "Self-starters who'll eventually want to run their own space",
    ],
    topSkills: [
      "Hands-on treatment technique (waxing, facials, lash work)",
      "Skin and anatomy knowledge — contra-indications matter",
      "Hygiene and sterilisation discipline (public-health critical)",
      "Client consultation and emotional attunement",
      "Retail + upselling without being pushy",
      "Booking and diary management",
    ],
    entryPaths: [
      "Vocational beauty therapy programme (videregående: Frisør, blomster, interiør og eksponeringsdesign → Hudpleie, 1–2 years)",
      "Fagbrev as Hudpleier (skin therapist) — adds regulated professional status",
      "Product-specific certifications (e.g. Dermalogica, HD Brows, classic + volume lashes)",
      "Apprenticeship in an established salon — the fastest way to build real speed",
    ],
    realityCheck: "The first two years are financially lean — you're building a client base and your hourly rate is low. Physical wear on your back, neck, and hands is real; therapists who don't invest in posture and a good chair leave the trade early. The upside: genuine loyalty from regulars, flexibility once you're established, and a clear path to running your own salon or going mobile.",
  },

  "hairstylist": {
    typicalDay: {
      morning: [
        "Open the salon — sweep, restock stations, lay out tools",
        "Check the day's bookings and prep colour formulations",
        "First client consultation — discuss look, timing, pricing",
        "Start cuts and colour applications on the earliest slots",
      ],
      midday: [
        "Run overlapping appointments — colour developing while cutting a second client",
        "Wash, blow-dry, style; take before/after photos for social",
        "Quick lunch between clients, respond to DM bookings",
        "Manage colour timers and client comfort simultaneously",
      ],
      afternoon: [
        "Walk-ins, fringe trims, men's cuts between booked slots",
        "Restock colour stock, mix dye for tomorrow's bookings",
        "End-of-day sweep, tool sterilisation, laundry",
        "Close till, post Instagram results, confirm tomorrow's clients",
      ],
      tools: [
        "Cutting shears & thinning shears",
        "Combs (cutting, tail, wide-tooth)",
        "Clippers & trimmers",
        "Hair dryers, diffusers, concentrators",
        "Round brushes & paddle brushes",
        "Section clips & butterfly clips",
        "Colour brushes & tint bowls",
        "Foils & balayage boards",
        "Straighteners & curling wands",
      ],
      environment: "Salon floor — bright, music-filled, social. On your feet 8+ hours a day. Fast-paced but collaborative with other stylists.",
    },
    whatYouActuallyDo: [
      "Consult clients on cut, colour, and maintenance before every service",
      "Cut, colour, blow-dry, and style across all hair types and lengths",
      "Mix colour formulations for each client's existing tone and desired result",
      "Manage your own booking diary, social-media presence, and product upsell",
      "Keep your station spotless — hair and hygiene are public-facing",
      "Continue education on new techniques (balayage, curly cutting, men's fades)",
    ],
    whoThisIsGoodFor: [
      "Creative people with a strong visual eye",
      "Genuinely like people — you're in conversation all day",
      "Physically durable — standing, arms-up, precision work for hours",
      "Detail-oriented about technique and cleanliness",
      "Entrepreneurial — most successful stylists eventually rent a chair or open their own",
    ],
    topSkills: [
      "Precision cutting (scissors + clipper + razor technique)",
      "Colour theory and formulation",
      "Client consultation and expectation management",
      "Blow-dry, styling, and event hair",
      "Retail + social-media marketing",
      "Physical stamina and posture discipline",
    ],
    entryPaths: [
      "Videregående Frisør programme (Vg1 + Vg2) + apprenticeship = fagbrev (4 years total)",
      "Private academies (Scandinavian Hair Academy, NORI) as a faster alternative",
      "Apprentice-first route at a salon that offers on-the-job training",
      "Specialist add-ons: colour correction, extensions, men's grooming, bridal",
    ],
    realityCheck: "The first 18 months as an apprentice pay poorly. Your earning power is driven entirely by client retention and efficiency — slow cutters don't make money. Wrist, shoulder, and back injuries are the #1 reason stylists leave the trade; take posture seriously. The upside: complete creative control of your output, loyal clients who book months ahead, and a clear path to chair-rental or salon ownership.",
  },

  "barber": {
    typicalDay: {
      morning: [
        "Sweep the shop floor, sanitise combs and clippers, set up station",
        "Open bookings + walk-in queue, check online waitlist",
        "First cuts — usually clean fades and short styles for work commuters",
        "Greet regulars by name, offer coffee or water",
      ],
      midday: [
        "Back-to-back 30-minute slots — cut, beard trim, hot-towel shave",
        "Queue management for walk-ins between booked slots",
        "Quick lunch during a natural lull",
        "Post-cut photos for Instagram, confirm afternoon bookings",
      ],
      afternoon: [
        "Busier run — school finishes, after-work crowd",
        "Longer services: full beard sculpt, hot shave, hair colour for men",
        "Deep clean between clients — barber standards are uncompromising on hygiene",
        "End of day: autoclave cycle on razors + scissors, restock",
      ],
      tools: [
        "Straight razors & safety razors",
        "Clippers (Wahl, Andis) with full guard set",
        "Trimmers (T-blade, foil)",
        "Barber scissors & thinning scissors",
        "Lathering brush & shaving cream bowl",
        "Hot-towel cabinet",
        "Neck dusters & capes",
        "Barber chair (hydraulic)",
        "Autoclave steriliser",
      ],
      environment: "Barbershop — louder, more masculine energy than a salon. Music, banter, sports on the TV. Fast turnover, heavy walk-in traffic, strong local community feel.",
    },
    whatYouActuallyDo: [
      "Deliver precision cuts, fades, and beard work on a 30-minute rhythm",
      "Perform hot-towel straight-razor shaves (regulated — requires certification)",
      "Handle walk-ins + bookings + regulars without losing anyone",
      "Build a local reputation — barbers live or die by word of mouth",
      "Maintain the shop standard: clean tools, clean floor, clean ears",
      "Upsell beard oil, pomade, and aftershave without being pushy",
    ],
    whoThisIsGoodFor: [
      "Fast, focused workers who thrive on repetition done well",
      "Easy conversationalists — clients return for the vibe as much as the cut",
      "Respect for tradition and craft — barbering has a long history",
      "Physically durable — standing + precision work all day",
      "Community-minded — a good barbershop is a neighbourhood anchor",
    ],
    topSkills: [
      "Fade technique (zero-fade, skin-fade, drop-fade, burst)",
      "Straight-razor technique and sharpening",
      "Beard sculpting and line-up",
      "Speed + precision under time pressure",
      "Customer rapport and retention",
      "Hygiene and tool maintenance",
    ],
    entryPaths: [
      "Videregående Frisør programme with barbering specialisation + fagbrev",
      "Private barbering academies (shorter, focused on men's work)",
      "Apprenticeship at an established barbershop",
      "Public-health certification required for straight-razor shaves in Norway",
    ],
    realityCheck: "Barbering is physically punishing — your wrists and back will know by your 30s if you don't care for them. The income ceiling in a shop is bounded by chair turnover; most experienced barbers move to chair-rental to take home more. Walk-in pressure is constant — slow days = no income on commission. But regulars become friends, and a well-run shop has one of the warmest atmospheres in any trade.",
  },

  "spa-therapist": {
    typicalDay: {
      morning: [
        "Arrive early — heat towels, warm oils, prep treatment rooms",
        "Light candles, check sound system, adjust room temperature",
        "Welcome first clients, walk through health-intake form",
        "First treatment — typically a longer massage or facial",
      ],
      midday: [
        "Back-to-back 60- or 90-minute treatments",
        "Turn rooms between clients: fresh linens, sanitise, reset music",
        "Drink water and stretch — massage work is a marathon, not a sprint",
        "Lunch in the staff area away from client earshot",
      ],
      afternoon: [
        "Body treatments, wraps, hot-stone massage, couples bookings",
        "Retail consultations — recommend home-care products post-treatment",
        "Laundry cycle on used linens, restock oils and towels",
        "End-of-day: deep sanitise, restock aromatherapy, lock up",
      ],
      tools: [
        "Adjustable-height massage table",
        "Hot-towel cabinet",
        "Oil warmers & essential-oil diffusers",
        "Hot-stone set & heater",
        "Steam shower / steam room",
        "Sound system (nature, ambient)",
        "Aromatherapy blends",
        "Linens, bolsters, face cradles",
        "Laundry equipment",
      ],
      environment: "Spa rooms — dim, warm, scented, quiet. The contrast with the busy reception is sharp. Calm outer demeanour all day, even when tired.",
    },
    whatYouActuallyDo: [
      "Deliver Swedish, deep tissue, hot-stone, aromatherapy massage",
      "Perform facials and body treatments alongside massage",
      "Read the client — some want silence, some want conversation",
      "Manage your own energy across 6+ treatments a day",
      "Upsell retail and wellness packages without breaking the atmosphere",
      "Keep up with technique training and specialisations (prenatal, lymphatic)",
    ],
    whoThisIsGoodFor: [
      "Calm, grounded presence — clients feel your energy",
      "Strong hands and physical endurance",
      "Empathetic listeners — clients share more than they realise",
      "Comfortable with silence and slower pace than a salon",
      "Interested in anatomy and bodywork as a craft",
    ],
    topSkills: [
      "Massage technique (Swedish, deep tissue, sports, prenatal)",
      "Anatomy and contra-indication awareness",
      "Client intake and boundary-setting",
      "Energy management and pacing",
      "Aromatherapy and product knowledge",
      "Hygiene and sterilisation discipline",
    ],
    entryPaths: [
      "Vocational massage therapist programme (fagbrev path via private schools)",
      "NMS (Norges Massasjeterapi-Skole) or similar certification",
      "Norsk Massasje- og Behandlerforbund membership for professional status",
      "Specialist certifications: prenatal, sports, lymphatic drainage, Thai, shiatsu",
    ],
    realityCheck: "Spa work is deeply rewarding but physically demanding — many therapists burn out by 40 without investing in their own body. Commission structures can mean quiet months = low income. You're emotional labour as well as physical labour; absorbing client stress is real and needs boundaries. The upside: genuine impact on people's wellbeing, a strong path to running a private practice, and demand for qualified therapists keeps rising in the Nordic wellness market.",
  },

  "skincare-specialist": {
    typicalDay: {
      morning: [
        "Open clinic — prep treatment rooms, calibrate skin analyser",
        "Review new-client intake forms and patch-test histories",
        "First consultation — skin scan, lifestyle review, goal setting",
        "Treatment: deep cleanse, extraction, or facial protocol",
      ],
      midday: [
        "Consultation-heavy period — skincare buyers often research at lunch",
        "Dermaplaning, LED therapy, chemical peels on booked slots",
        "Product education with clients — explain active ingredients, layering order",
        "Quick lunch, update client cards with progress photos",
      ],
      afternoon: [
        "Follow-ups from previous treatments — review skin response",
        "Advanced sessions (micro-needling, specialty peels) for experienced clients",
        "Retail consultations — design a home routine with products",
        "End-of-day deep clean, autoclave cycle, restock back bar",
      ],
      tools: [
        "Skin analyser (VISIA, OBSERV520)",
        "Magnifying lamp (5x or 10x)",
        "Dermaplaning blades",
        "LED light therapy mask",
        "Chemical peel kits (AHA, BHA, TCA)",
        "Extraction tools (loop, lancet)",
        "High-frequency wand",
        "Microcurrent device",
        "Steamer & facial brushes",
      ],
      environment: "Clinical but warm treatment rooms. Brighter than a spa — you need to see skin accurately. Strong product-display area up front.",
    },
    whatYouActuallyDo: [
      "Analyse skin objectively — measure hydration, pigmentation, elasticity",
      "Design treatment plans across 3–6 visits, not just one-off treatments",
      "Deliver facials, peels, LED therapy, dermaplaning, light microneedling",
      "Educate clients — most problems start with a broken home routine",
      "Recommend and sell product ranges as part of the treatment plan",
      "Keep pace with ingredient science and new actives (retinoids, peptides, exosomes)",
    ],
    whoThisIsGoodFor: [
      "Science-curious — ingredient nerds thrive here",
      "Good with consultation — you're selling a plan, not a transaction",
      "Detail-oriented about skin texture, tone, and change over time",
      "Commercially aware — retail sales are a real part of income",
      "Patient teachers — most of the work is coaching clients through their routine",
    ],
    topSkills: [
      "Skin assessment and analysis interpretation",
      "Ingredient knowledge (AHA/BHA, retinoids, peptides, SPF layering)",
      "Extraction technique and contra-indications",
      "Consultation-to-close sales without pressure",
      "LED / microcurrent / dermaplaning technique",
      "Progress documentation and photography",
    ],
    entryPaths: [
      "Hudpleier fagbrev — regulated skin-therapy qualification in Norway",
      "Videregående Frisør / Hudpleie line → fagbrev (4 years with apprenticeship)",
      "Advanced certifications (CIDESCO, Dermalogica Expert, Environ, ZO)",
      "Step up to medical aesthetic via nurse route if laser/injectable work appeals",
    ],
    realityCheck: "Norway's Hudpleier regulation is stricter than most countries — expect formal training, not a weekend course. Early income is modest; the best earners build a product-retail business alongside treatments. Clients with high expectations around 'miracle' results can drain you — set realistic expectations during consultation. Long-term, skincare specialists who specialise (acne, pigmentation, pre/post-surgical) build waitlists and command premium pricing.",
  },

  "laser-technician": {
    typicalDay: {
      morning: [
        "Switch on laser / IPL devices, run daily calibration + test fire",
        "Review day's bookings — hair removal, pigmentation, tattoo removal",
        "First consultation — skin Fitzpatrick type, medical history, patch-test check",
        "Deliver first session with strict protective-eyewear protocol",
      ],
      midday: [
        "Back-to-back hair-removal and skin-rejuvenation sessions",
        "Apply cooling gel, manage client discomfort, document session parameters",
        "Between clients: wipe handpieces, log device settings per client record",
        "Lunch in clinic to stay close to devices",
      ],
      afternoon: [
        "Longer tattoo-removal and pigmentation-correction sessions",
        "Follow-up consultations — review progress photos, adjust protocol",
        "End-of-day: shut down laser per manufacturer protocol, update maintenance log",
        "Restock consumables (cooling gel, eye shields, topical anaesthetic)",
      ],
      tools: [
        "Laser platforms (Candela GentleMax, Cynosure Elite+, Lumenis IPL)",
        "Protective eyewear (wavelength-specific)",
        "Cooling devices (Zimmer Cryo, contact cooling)",
        "Ultrasound cooling gel",
        "Topical anaesthetic (EMLA cream)",
        "Fitzpatrick photography setup",
        "Skin analyser",
        "Laser safety signage and lockable door",
      ],
      environment: "Clinical setting — bright, controlled-access laser room with interlocks. All staff in protective eyewear when laser is active. Strict record-keeping.",
    },
    whatYouActuallyDo: [
      "Assess skin type (Fitzpatrick I–VI) to pick safe treatment parameters",
      "Deliver hair removal, skin rejuvenation, vascular, and tattoo-removal treatments",
      "Manage client discomfort with cooling and numbing protocols",
      "Document every session: device, fluence, spot size, pulse duration, adverse events",
      "Handle rare adverse reactions (burns, pigmentation changes) per clinic protocol",
      "Stay current on laser physics, new platforms, and regulatory changes",
    ],
    whoThisIsGoodFor: [
      "Detail-oriented — documentation and safety are non-negotiable",
      "Comfortable with clinical environments and medical aesthetics",
      "Scientifically curious — laser-tissue interaction is physics",
      "Calm under pressure — clients can be anxious, especially first session",
      "Long-game thinkers — results come over 6–10 sessions, not one",
    ],
    topSkills: [
      "Laser physics and parameter selection",
      "Fitzpatrick skin-type assessment",
      "Protocol documentation and record-keeping",
    ...
    entryPaths: [
      "Hudpleier fagbrev + laser-specific certification (manufacturer-led)",
      "Nurse (sykepleier) route with aesthetic specialisation — broader treatment scope",
      "Private laser-safety courses (BTEC Level 4 equivalent)",
      "Required: Direktoratet for strålevern og atomsikkerhet (DSA) registration for clinic",
    ],
    realityCheck: "Norway regulates medical lasers strictly — you must work under a clinic with proper DSA registration, which limits freelancing. Device manufacturers offer strong career ladders but the equipment is expensive (500K+ NOK per platform). Adverse events, though rare, are real — a Fitzpatrick V client treated as a Fitzpatrick III gets burned. The upside: high earning potential, consistent demand, and a clear specialism path into medical aesthetics.",
  },

  "tattoo-artist": {
    typicalDay: {
      morning: [
        "Open studio — run autoclave cycle, lay out sterile workstation",
        "Review day's bookings, check reference images clients have sent",
        "Stencil application and final design sign-off with first client",
        "Set up machine, needles, inks — new single-use for every client",
      ],
      midday: [
        "First session — small pieces (30–90 min) or start of a longer commitment",
        "Lunch break mid-session on longer tattoos to let the skin rest",
        "Second booking — often a follow-up on a larger piece in progress",
        "Process card payments, photograph finished work for portfolio",
      ],
      afternoon: [
        "Design work for upcoming bookings — freehand sketching at the desk",
        "Consultations for future work — placement, size, budget, timing",
        "Social-media posts of completed pieces (primary marketing channel)",
        "End-of-day: disassemble machine, sterilise, autoclave needles + tubes",
      ],
      tools: [
        "Rotary and coil tattoo machines",
        "Cartridge needles (liners, shaders, magnums)",
        "Pre-dispersed ink (black + full colour range)",
        "Stencil paper & thermal printer",
        "Autoclave steriliser",
        "Rubber bands, clip cord, grips",
        "Dermashield wrap / Saniderm",
        "Light table / iPad Pro for design work",
        "Ink caps, green soap, disposable razors",
      ],
      environment: "Tattoo studio — music, art on walls, mix of quiet concentration and banter. Physical work bent over clients for hours. Strict hygiene discipline.",
    },
    whatYouActuallyDo: [
      "Design custom artwork from client brief — freehand, digital, or collaborative",
      "Tattoo clients across 1–6 hour sessions depending on piece size",
      "Maintain sterility through single-use needles, inks, and barrier protection",
      "Build a portfolio — social media is your CV, your booking channel, and your marketing",
      "Handle aftercare education and troubleshoot healing issues",
      "Manage your own bookings, deposits, pricing, and taxes (most are self-employed)",
    ],
    whoThisIsGoodFor: [
      "Strong visual artists with a deep interest in drawing and design",
      "Physically durable — bent-over work for hours, hands get tired",
      "Self-disciplined — you're a small business as much as an artist",
      "Good with clients — intimate, sometimes anxious, long sessions together",
      "Thick-skinned about criticism — your portfolio is public and judged constantly",
    ],
    topSkills: [
      "Drawing fundamentals (linework, shading, composition)",
      "Machine control — line weight, saturation, depth consistency",
      "Sterile technique and cross-contamination prevention",
      "Portfolio development and social-media curation",
      "Client consultation and design translation",
      "Pricing and small-business admin",
    ],
    entryPaths: [
      "Apprenticeship under a licensed, established tattoo artist (2–3 years typical)",
      "Folkehelseinstituttet public-health certification required to operate in Norway",
      "Self-taught route is possible but dramatically harder to land clients",
      "Studio registration with local municipality for hygiene compliance",
    ],
    realityCheck: "The apprenticeship years are financially brutal — you're doing shop cleanup and practice tattoos on friends while earning nothing. Social media dictates career trajectory more than skill in the first five years. Physical wear on wrists, neck, and back is real — many artists leave the trade by 40 from injury. The upside: genuine artistic fulfilment, a fiercely loyal client base once established, and complete creative control of your work and schedule.",
  },

  "piercing-specialist": {
    typicalDay: {
      morning: [
        "Open studio — run autoclave, set up sterile trays, lay out jewellery displays",
        "Review day's bookings, confirm any under-18 consent paperwork",
        "First client consultation — anatomy check, jewellery choice, placement mark",
        "Perform piercing with sterile technique, walk client through aftercare",
      ],
      midday: [
        "Back-to-back piercings — mostly ears, nose, lip, nipple, navel",
        "Longer consultations for complex work (industrial, dermal, surface piercings)",
        "Jewellery-change appointments for existing clients (healing milestones)",
        "Lunch in studio, restock needles and jewellery",
      ],
      afternoon: [
        "Afternoon rush — school finishes, after-work clients",
        "Consultations with parents for under-18 ear piercings (legal + ethical care)",
        "Troubleshoot healing issues on previous clients — rotation, irritation, migration",
        "End of day: autoclave cycle, sanitise surfaces, update client records",
      ],
      tools: [
        "Needles (gauges 18–10 depending on placement)",
        "Piercing clamps (Foerster, Pennington)",
        "Implant-grade jewellery (ASTM F136 titanium, 14k/18k gold)",
        "Autoclave steriliser",
        "Surgical markers (skin-safe)",
        "Sterile saline spray for aftercare",
        "Measuring calipers",
        "Barrier-wrapped equipment trays",
      ],
      environment: "Small studio room — bright clinical lighting for precision work, but welcoming decor. Clean to a surgical standard. Often attached to a tattoo studio or runs solo.",
    },
    whatYouActuallyDo: [
      "Assess client anatomy — not every piercing is possible on every body",
      "Explain jewellery quality, material, and long-term care before committing",
      "Perform piercings with sterile, single-use needles (never piercing guns)",
      "Guide clients through 3–6 months of healing with targeted aftercare advice",
      "Handle jewellery changes, downsizing, and troubleshooting through the healing period",
      "Keep up with industry standards (APP — Association of Professional Piercers)",
    ],
    whoThisIsGoodFor: [
      "Precise, steady hands under time pressure",
      "Calm presence — most clients are nervous, some are first-timers",
      "Detail-oriented about anatomy and asymmetry",
      "Ethical backbone — saying no to a bad idea is part of the job",
      "Interested in body modification as a serious craft, not a gimmick",
    ],
    topSkills: [
      "Anatomical assessment and placement judgment",
      "Sterile technique and autoclave operation",
      "Jewellery material knowledge (why piercing guns ruin healing)",
      "Client consultation and expectation-setting",
      "Healing troubleshooting across months of follow-up",
      "Aftercare education (simple, repeatable, accurate)",
    ],
    entryPaths: [
      "Apprenticeship under an APP-member piercer (1–2 years typical)",
      "Folkehelseinstituttet public-health certification to operate in Norway",
      "Municipality registration for the studio",
      "Self-study on anatomy, jewellery standards, and industry ethics is expected ongoing",
    ],
    realityCheck: "The apprenticeship is unpaid or low-paid while you build skill and portfolio. Income is limited by piercing speed — there's a floor on how fast you can work without cutting corners on sterility or consultation quality. Clients expect jewellery perfection at trade-price margins, so your supplier relationships matter. The upside: genuinely helping people feel more at home in their body, consistent demand, and a clear niche for specialists (e.g. surface piercings, complex ear projects).",
  },

  "wellness-coach": {
    typicalDay: {
      morning: [
        "Review today's client list and prep individualised session notes",
        "First session — usually a new-client intake or progress check",
        "Adjust meal plans, sleep targets, or habit trackers based on weekly check-ins",
        "Outreach: respond to DMs, reply to new enquiries, confirm afternoon sessions",
      ],
      midday: [
        "Back-to-back 45–60 minute sessions, in-person or video",
        "Content creation between clients — weekly newsletter, social post, blog",
        "Continuing education: new research, certifications, peer supervision",
        "Lunch break — wellness coaches should model their own advice",
      ],
      afternoon: [
        "Post-work slot — most clients book evenings for accessibility",
        "Review the day's session notes and log in client-management software",
        "Prep meal plans, habit trackers, or worksheets for tomorrow's clients",
        "Set tomorrow's schedule; block focused work time for business admin",
      ],
      tools: [
        "Client-management software (Practice Better, SimplePractice, Healthie)",
        "Video conferencing (Zoom, Whereby)",
        "Habit-tracking apps or templates (Notion, custom Google Sheet)",
        "Food-logging apps (MyFitnessPal, Cronometer) for client use",
        "Body-composition scales (optional, for in-person)",
        "Wearable data (Oura, Whoop, Garmin) via client sync",
        "Newsletter / marketing tools (Substack, Beehiiv, ConvertKit)",
      ],
      environment: "Mostly remote or hybrid — home office, co-working space, or private consult room. 60–80% of work is sessions; the rest is content, admin, and CPD.",
    },
    whatYouActuallyDo: [
      "Run structured coaching sessions on nutrition, sleep, stress, movement, and habits",
      "Co-design goals with clients — SMART targets, not generic advice",
      "Track progress across weeks and months with honest, kind feedback",
      "Create content (newsletter, social, podcast) to build authority and leads",
      "Refer out when something is clinical — coaches are not therapists or dietitians",
      "Run the business: pricing, contracts, invoicing, tax",
    ],
    whoThisIsGoodFor: [
      "Warm, empathetic listeners who also know when to push",
      "Comfortable with ambiguity — behaviour change is non-linear",
      "Boundary-setters — coaching is emotional labour, you need limits",
      "Entrepreneurial — most coaches run their own practice",
      "Naturally curious about health, psychology, and human behaviour",
    ],
    topSkills: [
      "Coaching methodology (motivational interviewing, GROW model)",
      "Nutrition literacy — enough to coach, aware of when to refer",
      "Behaviour-change psychology (habits, loops, triggers)",
      "Boundary and scope-of-practice discipline",
      "Marketing and personal-brand building",
      "Business admin — contracts, pricing, client agreements",
    ],
    entryPaths: [
      "ICF-accredited coaching certification (ACC → PCC → MCC ladder)",
      "NLCC or IIN (Institute for Integrative Nutrition) for wellness-specific training",
      "Optional: Norwegian ernæringsrådgiver cert, exercise-science background, yoga/pilates",
      "Liability insurance + Brønnøysund business registration before taking paying clients",
    ],
