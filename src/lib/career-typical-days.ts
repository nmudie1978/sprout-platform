...
const careerDetailsMap: Record<string, CareerDetails> = {
  ...
  "cybersecurity-analyst": {
    ...
    realityCheck: "Constant vigilance required. Attackers evolve faster than defenses. Can be stressful during incidents. But protecting organisations is rewarding.",
  },
