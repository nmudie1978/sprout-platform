...
Many young people want to work but don't know where to start. Traditional job boards are designed for adults with CVs and experience. Asking around feels awkward. And for parents, there's often uncertainty about who their child is actually working for.
...
Young people can browse jobs posted in their area — tasks that match their age, availability, and interests. These might be one-time gigs, weekend work, or short-term projects. Everything is local, manageable, and designed for people just starting out.
...
We know that not all young people have BankID. That's why youth can sign up using Vipps or other age-appropriate verification methods. This makes the platform accessible while still confirming that users are who they say they are.
...
If something feels wrong, users can report it immediately. Blocking is simple and effective. We review reports seriously and take action when needed. The goal is an environment where problems are easy to flag and quick to address.
...
Young people today are entering a job market that looks different from the one their parents knew.

Artificial intelligence is changing how many jobs are done. Some roles are disappearing. Others are emerging. Skills that were once optional — like digital literacy, adaptability, and communication — are now essential almost everywhere.
...
We believe that young people are capable, curious, and ready to contribute. They don't need to be protected from work — they need access to appropriate work in a safe environment.

We believe parents want to support their children's independence, not control it. They need enough information to feel confident, not surveillance tools that undermine trust.
...
- **Clean and calm:** Generous white space, no clutter, no aggressive calls-to-action
- **Professional but approachable:** Suitable for both a 16-year-old and their parent to read comfortably
- **Trust-focused:** Design should feel institutional and reliable, not startup-flashy
- **Typography:** Clear, readable fonts. Body text at 16-18px minimum. Strong hierarchy with headings.

### Content Layout

- **Clear section headings:** Each major section should have a distinct heading, easily scannable
- **Short paragraphs:** No paragraph longer than 4-5 sentences. Break up dense information.
- **No sidebar distractions:** Full-width content, focused reading experience
- **Mobile-first:** Many users will read this on phones. Ensure it reads well at all screen sizes.

### Things to Avoid

- Marketing language or promotional tone
- Stock photos of smiling teenagers (feels inauthentic)
- Testimonials or social proof (save for other pages)
- Signup buttons mid-content (keep focus on information)
- Animations or interactive elements that distract from reading

### Optional Enhancements

- **Icons:** Simple, professional icons next to key safety features can aid scanning
- **Pull quotes:** Highlight key phrases like "Safety isn't an add-on — it's a core design principle"
- **Anchor links:** For longer pages, a table of contents at the top helps navigation
- **Language toggle:** If serving both Norwegian and English speakers, make language switching obvious
